...
fun main() {
    ...
    val studyData: StudyData = StudyData.readData(studySet)
...
private fun formatChapterRef(chapterRef: ChapterRef?): String =
    chapterRef?.format(FULL_BOOK_FORMAT) ?: "None of these"
...
private fun writeHeadingsKahoot(
    ...
    productsPath: Path = defaultProductsPath,
): Path {
...
//    fileName += "-%04d".format(randomSeed)
    ...
    val xlsxFile = productsPath.resolve(setName, "kahoot", "headings", "$fileName.xlsx")
    kahoot(xlsxFile) {
