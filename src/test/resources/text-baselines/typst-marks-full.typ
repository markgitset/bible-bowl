...
#versenum(2) “#myhl(men)[Moses] my servant is dead. Now therefore arise, go over this #myhl(places)[Jordan], you and all this people, into the land that I am giving to them, to the people of #myname[Israel]. 
...
#versenum(4) From the wilderness and this #myhl(places)[Lebanon] as far as the great river, the river #myhl(places)[Euphrates], all the land of the #myname[Hittites] to the #myhl(places)[Great Sea] toward the going down of the sun shall be your territory. 
...
#versenum(11) “Pass through the midst of the camp and command the people, ‘Prepare your provisions, for within #mynumber[three] days you are to pass over this #myhl(places)[Jordan] to go in to take possession of the land that the #myhl(divine)[#smallcaps[Lord] your God] is giving you to possess.’”


  
#versenum(12) And to the #myname[Reubenites], the #myname[Gadites], and the #mynumber[half]-tribe of #myname[Manasseh] #myhl(men)[Joshua] said, 
...
#versenum(1) And #myhl(men)[Joshua] the son of #myhl(men)[Nun] sent#footnote[Joshua 2:1 Or #emph[had sent]] #mynumber[two] men secretly from #myhl(places)[Shittim] as spies, saying, “Go, view the land, #underline[especially] #myhl(places)[Jericho].” And they went and came into the house of a prostitute whose name was #myhl(women)[Rahab] and lodged there. 
#versenum(2) And it was told to the king of #myhl(places)[Jericho], “Behold, men of #myname[Israel] have come here tonight to search out the land.” 
...
#versenum(10) For we have heard how the #myhl(divine)[#smallcaps[Lord]] dried up the water of the #myhl(places)[Red Sea] before you when you came out of #myhl(places)[Egypt], and what you did to the #mynumber[two] kings of the #myname[Amorites] who were beyond the #myhl(places)[Jordan], to #myhl(men)[Sihon] and #myhl(men)[Og], whom you devoted to destruction.#footnote[Joshua 2:10 That is, set apart (devoted) as an offering to the Lord (for destruction)] 
...
#versenum(23) Then the #mynumber[two] men returned. They came down from the hills and passed over and came to #myhl(men)[Joshua] the son of #myhl(men)[Nun], and they told him all that had happened to them. 
...
#versenum(1) Then #myhl(men)[Joshua] rose early in the morning and they set out from #myhl(places)[Shittim]. And they came to the #myhl(places)[Jordan], he and all the people of #myname[Israel], and lodged there before they passed over. 
...
#versenum(7) The #myhl(divine)[#smallcaps[Lord]] said to #myhl(men)[Joshua], “Today I will begin to #underline[exalt] you in the sight of all #myname[Israel], that they may know that, as I was with #myhl(men)[Moses], so I will be with you. 
...
#versenum(9) And #myhl(men)[Joshua] said to the people of #myname[Israel], “Come here and listen to the words of the #myhl(divine)[#smallcaps[Lord] your God].” 
...
#versenum(13) And when the soles of the feet of the priests bearing the ark of the #myhl(divine)[#smallcaps[Lord]], the #myhl(divine)[Lord] of all the earth, shall rest in the waters of the #myhl(places)[Jordan], the waters of the #myhl(places)[Jordan] shall be cut off from flowing, and the waters coming down from above shall stand in #mynumber[one] heap.”
...
#versenum(17) Now the priests bearing the ark of the covenant of the #myhl(divine)[#smallcaps[Lord]] stood firmly on dry ground in the midst of the #myhl(places)[Jordan], and all #myname[Israel] was passing over on dry ground until all the nation finished passing over the #myhl(places)[Jordan].
...
#versenum(3) and command them, saying, ‘Take #mynumber[twelve] stones from here out of the midst of the #myhl(places)[Jordan], from the very place where the priests’ feet stood firmly, and bring them over with you and lay them down in the place where you lodge tonight.’” 
#versenum(4) Then #myhl(men)[Joshua] called the #mynumber[twelve] men from the people of #myname[Israel], whom he had appointed, a man from each tribe. 
#versenum(5) And #myhl(men)[Joshua] said to them, “Pass on before the ark of the #myhl(divine)[#smallcaps[Lord] your God] into the midst of the #myhl(places)[Jordan], and take up each of you a stone upon his shoulder, according to the number of the tribes of the people of #myname[Israel], 
...
#versenum(8) And the people of #myname[Israel] did just as #myhl(men)[Joshua] commanded and took up #mynumber[twelve] stones out of the midst of the #myhl(places)[Jordan], according to the number of the tribes of the people of #myname[Israel], just as the #myhl(divine)[#smallcaps[Lord]] told #myhl(men)[Joshua]. And they carried them over with them to the place where they lodged and laid them down#footnote[Joshua 4:8 Or #emph[to rest]] there. 
#versenum(9) And #myhl(men)[Joshua] set up#footnote[Joshua 4:9 Or #emph[Joshua had set up]] #mynumber[twelve] stones in the midst of the #myhl(places)[Jordan], in the place where the feet of the priests bearing the ark of the covenant had stood; and they are there to this day. 
...
#versenum(12) The sons of #myname[Reuben] and the sons of #myname[Gad] and the #mynumber[half]-tribe of #myname[Manasseh] passed over armed before the people of #myname[Israel], as #myhl(men)[Moses] had told them. 
#versenum(13) About #underline[#mynumber[40,000]] ready for war passed over before the #myhl(divine)[#smallcaps[Lord]] for battle, to the plains of #myhl(places)[Jericho]. 
#versenum(14) On that day the #myhl(divine)[#smallcaps[Lord]] #underline[exalted] #myhl(men)[Joshua] in the sight of all #myname[Israel], and they stood in awe of him just as they had stood in awe of #myhl(men)[Moses], all the days of his life.
...
#versenum(19) The people came up out of the #myhl(places)[Jordan] on the #underline[#mynumber[tenth]] day of the #mynumber[first] month, and they encamped at #myhl(places)[Gilgal] on the east border of #myhl(places)[Jericho]. 
#versenum(20) And those #mynumber[twelve] stones, which they took out of the #myhl(places)[Jordan], #myhl(men)[Joshua] set up at #myhl(places)[Gilgal]. 
...
#versenum(22) then you shall let your children know, ‘#myname[Israel] passed over this #myhl(places)[Jordan] on dry ground.’ 
...
#versenum(1) As soon as all the kings of the #myname[Amorites] who were beyond the #myhl(places)[Jordan] to the west, and all the kings of the #myname[Canaanites] who were by the sea, heard that the #myhl(divine)[#smallcaps[Lord]] had dried up the waters of the #myhl(places)[Jordan] for the people of #myname[Israel] until they had crossed over, their hearts melted and there was no longer any spirit in them because of the people of #myname[Israel].


  
#versenum(2) At that time the #myhl(divine)[#smallcaps[Lord]] said to #myhl(men)[Joshua], “Make flint knives and #underline[circumcise] the sons of #myname[Israel] a #mynumber[second] time.” 
#versenum(3) So #myhl(men)[Joshua] made flint knives and circumcised the sons of #myname[Israel] at #underline[#myhl(places)[Gibeath-haaraloth]].#footnote[Joshua 5:3 #emph[Gibeath-haaraloth] means #emph[the hill of the foreskins]] 
...
#versenum(10) While the people of #myname[Israel] were encamped at #myhl(places)[Gilgal], they kept the #myname[Passover] on the #underline[#mynumber[fourteenth]] day of the month in the evening on the plains of #myhl(places)[Jericho]. 
...
#versenum(12) And the manna ceased the day after they ate of the produce of the land. And there was no longer manna for the people of #myname[Israel], but they ate of the fruit of the land of #myhl(places)[Canaan] that year.
...
#versenum(1) Now #myhl(places)[Jericho] was shut up inside and outside because of the people of #myname[Israel]. None went out, and none came in. 
...
#versenum(6) So #myhl(men)[Joshua] the son of #myhl(men)[Nun] called the priests and said to them, “Take up the ark of the covenant and let #mynumber[seven] priests bear #mynumber[seven] trumpets of rams’ horns before the ark of the #myhl(divine)[#smallcaps[Lord]].” 
...
#versenum(8) And just as #myhl(men)[Joshua] had commanded the people, the #mynumber[seven] priests bearing the #mynumber[seven] trumpets of rams’ horns before the #myhl(divine)[#smallcaps[Lord]] went forward, blowing the trumpets, with the ark of the covenant of the #myhl(divine)[#smallcaps[Lord]] following them. 
...
#versenum(13) And the #mynumber[seven] priests bearing the #mynumber[seven] trumpets of rams’ horns before the ark of the #myhl(divine)[#smallcaps[Lord]] walked on, and they blew the trumpets continually. And the armed men were walking before them, and the rear guard was walking after the ark of the #myhl(divine)[#smallcaps[Lord]], while the trumpets blew continually. 
...
#versenum(16) And at the #mynumber[seventh] time, when the priests had blown the trumpets, #myhl(men)[Joshua] said to the people, “Shout, for the #myhl(divine)[#smallcaps[Lord]] has given you the city. 
...
#versenum(22) But to the #mynumber[two] men who had spied out the land, #myhl(men)[Joshua] said, “Go into the #underline[prostitute’s] house and bring out from there the woman and all who belong to her, as you swore to her.” 
...
#versenum(1) But the people of #myname[Israel] broke faith in regard to the devoted things, for #myhl(men)[Achan] the son of #myhl(men)[Carmi], son of #myhl(men)[Zabdi], son of #myhl(men)[Zerah], of the tribe of #myname[Judah], took some of the devoted things. And the anger of the #myhl(divine)[#smallcaps[Lord]] burned against the people of #myname[Israel].
...
#versenum(3) And they returned to #myhl(men)[Joshua] and said to him, “Do not have all the people go up, but let about #mynumber[two] or #mynumber[three thousand] men go up and attack #myhl(places)[Ai]. Do not make the whole people #underline[toil] up there, for they are #underline[few].” 
#versenum(4) So about #mynumber[three thousand] men went up there from the people. And they fled before the men of #myhl(places)[Ai], 
#versenum(5) and the men of #myhl(places)[Ai] killed about #underline[#mynumber[thirty-six]] of their men and chased them before the gate as far as #underline[#myhl(places)[Shebarim]] and struck them at the #underline[descent]. And the hearts of the people melted and became as water.


  
#versenum(6) Then #myhl(men)[Joshua] tore his clothes and fell to the earth on his face before the ark of the #myhl(divine)[#smallcaps[Lord]] until the evening, he and the elders of #myname[Israel]. And they put #underline[dust] on their heads. 
#versenum(7) And #myhl(men)[Joshua] said, “Alas, O #myhl(divine)[Lord] #myhl(divine)[GOD], why have you brought this people over the #myhl(places)[Jordan] at all, to give us into the hands of the #myname[Amorites], to destroy us? Would that we had been content to dwell beyond the #myhl(places)[Jordan]! 
#versenum(8) O #myhl(divine)[Lord], what can I say, when #myname[Israel] has turned their backs before their enemies! 
...
#versenum(13) Get up! Consecrate the people and say, ‘Consecrate yourselves for tomorrow; for thus says the #myhl(divine)[#smallcaps[Lord], God of Israel], “There are devoted things in your midst, O #myname[Israel]. You cannot stand before your enemies until you take away the devoted things from among you.” 
...
#versenum(16) So #myhl(men)[Joshua] rose early in the morning and brought #myname[Israel] near tribe by tribe, and the tribe of #myname[Judah] was taken. 
#versenum(17) And he brought near the clans of #myname[Judah], and the clan of the #myname[Zerahites] was taken. And he brought near the clan of the #myname[Zerahites] man by man, and #myhl(men)[Zabdi] was taken. 
#versenum(18) And he brought near his household man by man, and #myhl(men)[Achan] the son of #myhl(men)[Carmi], son of #myhl(men)[Zabdi], son of #myhl(men)[Zerah], of the tribe of #myname[Judah], was taken. 
...
#versenum(23) And they took them out of the tent and brought them to #myhl(men)[Joshua] and to all the people of #myname[Israel]. And they laid them down before the #myhl(divine)[#smallcaps[Lord]]. 
#versenum(24) And #myhl(men)[Joshua] and all #myname[Israel] with him took #myhl(men)[Achan] the son of #myhl(men)[Zerah], and the silver and the cloak and the bar of gold, and his sons and daughters and his oxen and donkeys and sheep and his tent and all that he had. And they brought them up to the #myhl(places)[Valley of Achor]. 
#versenum(25) And #myhl(men)[Joshua] said, “Why did you bring trouble on us? The #myhl(divine)[#smallcaps[Lord]] #underline[brings] trouble on you today.” And all #myname[Israel] stoned him with stones. They burned them with fire and stoned them with stones. 
...
#versenum(3) So #myhl(men)[Joshua] and all the fighting men arose to go up to #myhl(places)[Ai]. And #myhl(men)[Joshua] #underline[chose] #underline[#mynumber[30,000]] mighty men of valor and sent them out by night. 
...
#versenum(10) #myhl(men)[Joshua] arose early in the morning and mustered the people and went up, he and the elders of #myname[Israel], before the people to #myhl(places)[Ai]. 
...
#versenum(12) He took about #underline[#mynumber[5,000]] men and set them in ambush between #myhl(places)[Bethel] and #myhl(places)[Ai], to the west of the city. 
...
#versenum(14) And as soon as the king of #myhl(places)[Ai] saw this, he and all his people, the men of the city, hurried and went out early to the appointed place#footnote[Joshua 8:14 Hebrew #emph[appointed time]] toward the #myhl(places)[Arabah] to meet #myname[Israel] in battle. But he did not know that there was an ambush against him behind the city. 
#versenum(15) And #myhl(men)[Joshua] and all #myname[Israel] #underline[pretended] to be #underline[beaten] before them and fled in the direction of the wilderness. 
...
#versenum(17) Not a man was left in #myhl(places)[Ai] or #myhl(places)[Bethel] who did not go out after #myname[Israel]. They left the city open and pursued #myname[Israel].
...
#versenum(21) And when #myhl(men)[Joshua] and all #myname[Israel] saw that the ambush had captured the city, and that the smoke of the city went up, then they turned back and struck down the men of #myhl(places)[Ai]. 
...
#versenum(24) When #myname[Israel] had finished killing all the inhabitants of #myhl(places)[Ai] in the open wilderness where they pursued them, and all of them to the very last had fallen by the edge of the sword, all #myname[Israel] returned to #myhl(places)[Ai] and struck it down with the edge of the sword. 
#versenum(25) And all who fell that day, both men and women, were #mynumber[12,000], all the people of #myhl(places)[Ai]. 
...
#versenum(27) Only the livestock and the spoil of that city #myname[Israel] took as their plunder, according to the word of the #myhl(divine)[#smallcaps[Lord]] that he commanded #myhl(men)[Joshua]. 
...
#versenum(31) just as #myhl(men)[Moses] the servant of the #myhl(divine)[#smallcaps[Lord]] had commanded the people of #myname[Israel], as it is written in the Book of the Law of #myhl(men)[Moses], “an altar of #underline[uncut] stones, upon which no man has #underline[wielded] an iron #underline[tool].” And they offered on it burnt offerings to the #myhl(divine)[#smallcaps[Lord]] and sacrificed peace offerings. 
#versenum(32) And there, in the presence of the people of #myname[Israel], he wrote on the stones a copy of the law of #myhl(men)[Moses], which he had written. 
#versenum(33) And all #myname[Israel], #underline[sojourner] as well as native born, with their elders and officers and their judges, stood on opposite sides of the ark before the Levitical priests who carried the ark of the covenant of the #myhl(divine)[#smallcaps[Lord]], #mynumber[half] of them in front of #myhl(places)[Mount Gerizim] and #mynumber[half] of them in front of #myhl(places)[Mount Ebal], just as #myhl(men)[Moses] the servant of the #myhl(divine)[#smallcaps[Lord]] had commanded at the first, to bless the people of #myname[Israel]. 
...
#versenum(35) There was not a word of all that #myhl(men)[Moses] commanded that #myhl(men)[Joshua] did not read before all the assembly of #myname[Israel], and the women, and the little ones, and the #underline[sojourners] who lived#footnote[Joshua 8:35 Or #emph[traveled]] among them.
...
#versenum(2) they gathered together as one to fight against #myhl(men)[Joshua] and #myname[Israel].
...
#versenum(6) And they went to #myhl(men)[Joshua] in the camp at #myhl(places)[Gilgal] and said to him and to the men of #myname[Israel], “We have come from a distant country, so now make a covenant with us.” 
...
#versenum(10) and all that he did to the #mynumber[two] kings of the #myname[Amorites] who were beyond the #myhl(places)[Jordan], to #myhl(men)[Sihon] the king of #myhl(places)[Heshbon], and to #myhl(men)[Og] king of #myhl(places)[Bashan], who lived in #myhl(places)[Ashtaroth]. 
...
#versenum(17) And the people of #myname[Israel] set out and reached their cities on the #mynumber[third] day. Now their cities were #myhl(places)[Gibeon], #myhl(places)[Chephirah], #myhl(places)[Beeroth], and #myhl(places)[Kiriath-jearim]. 
#versenum(18) But the people of #myname[Israel] did not attack them, because the leaders of the congregation had sworn to them by the #myhl(divine)[#smallcaps[Lord], the God of Israel]. Then all the congregation #underline[murmured] against the leaders. 
...
#versenum(4) “Come up to me and help me, and let us strike #myhl(places)[Gibeon]. For it has made peace with #myhl(men)[Joshua] and with the people of #myname[Israel].” 
#versenum(5) Then the #mynumber[five] kings of the #myname[Amorites], the king of #myhl(places)[Jerusalem], the king of #myhl(places)[Hebron], the king of #myhl(places)[Jarmuth], the king of #myhl(places)[Lachish], and the king of #myhl(places)[Eglon], gathered their forces and went up with all their #underline[armies] and encamped against #myhl(places)[Gibeon] and made war against it.


  
#versenum(6) And the men of #myhl(places)[Gibeon] sent to #myhl(men)[Joshua] at the camp in #myhl(places)[Gilgal], saying, “Do not #underline[relax] your hand from your servants. Come up to us quickly and save us and help us, for all the kings of the #myname[Amorites] who dwell in the hill country are gathered against us.” 
...
#versenum(12) At that time #myhl(men)[Joshua] spoke to the #myhl(divine)[#smallcaps[Lord]] in the day when the #myhl(divine)[#smallcaps[Lord]] gave the #myname[Amorites] over to the sons of #myname[Israel], and he said in the sight of #myname[Israel],
...
#versenum(14) There has been no day like it before or since, when the #myhl(divine)[#smallcaps[Lord]] #underline[heeded] the voice of a man, for the #myhl(divine)[#smallcaps[Lord]] fought for #myname[Israel].


  
#versenum(15) So #myhl(men)[Joshua] returned, and all #myname[Israel] with him, to the camp at #myhl(places)[Gilgal].
...
#versenum(16) These #mynumber[five] kings fled and hid themselves in the cave at #myhl(places)[Makkedah]. 
#versenum(17) And it was told to #myhl(men)[Joshua], “The #mynumber[five] kings have been found, hidden in the cave at #myhl(places)[Makkedah].” 
...
#versenum(20) When #myhl(men)[Joshua] and the sons of #myname[Israel] had finished striking them with a great blow until they were #underline[wiped] out, and when the remnant that remained of them had entered into the fortified cities, 
#versenum(21) then all the people returned #underline[safe] to #myhl(men)[Joshua] in the camp at #myhl(places)[Makkedah]. Not a man moved his tongue against any of the people of #myname[Israel].


  
#versenum(22) Then #myhl(men)[Joshua] said, “Open the mouth of the cave and bring those #mynumber[five] kings out to me from the cave.” 
#versenum(23) And they did so, and brought those #mynumber[five] kings out to him from the cave, the king of #myhl(places)[Jerusalem], the king of #myhl(places)[Hebron], the king of #myhl(places)[Jarmuth], the king of #myhl(places)[Lachish], and the king of #myhl(places)[Eglon]. 
#versenum(24) And when they brought those kings out to #myhl(men)[Joshua], #myhl(men)[Joshua] summoned all the men of #myname[Israel] and said to the chiefs of the men of war who had gone with him, “Come near; put your feet on the necks of these kings.” Then they came near and put their feet on their necks. 
...
#versenum(26) And afterward #myhl(men)[Joshua] struck them and put them to death, and he hanged them on #mynumber[five] trees. And they #underline[hung] on the trees until evening. 
...
#versenum(29) Then #myhl(men)[Joshua] and all #myname[Israel] with him passed on from #myhl(places)[Makkedah] to #myhl(places)[Libnah] and fought against #myhl(places)[Libnah]. 
#versenum(30) And the #myhl(divine)[#smallcaps[Lord]] gave it also and its king into the hand of #myname[Israel]. And he struck it with the edge of the sword, and every person in it; he left none remaining in it. And he did to its king as he had done to the king of #myhl(places)[Jericho].


  
#versenum(31) Then #myhl(men)[Joshua] and all #myname[Israel] with him passed on from #myhl(places)[Libnah] to #myhl(places)[Lachish] and laid siege to it and fought against it. 
#versenum(32) And the #myhl(divine)[#smallcaps[Lord]] gave #myhl(places)[Lachish] into the hand of #myname[Israel], and he captured it on the #mynumber[second] day and struck it with the edge of the sword, and every person in it, as he had done to #myhl(places)[Libnah].
...
#versenum(34) Then #myhl(men)[Joshua] and all #myname[Israel] with him passed on from #myhl(places)[Lachish] to #myhl(places)[Eglon]. And they laid siege to it and fought against it. 
...
#versenum(36) Then #myhl(men)[Joshua] and all #myname[Israel] with him went up from #myhl(places)[Eglon] to #myhl(places)[Hebron]. And they fought against it 
...
#versenum(38) Then #myhl(men)[Joshua] and all #myname[Israel] with him turned back to #myhl(places)[Debir] and fought against it 
...
#versenum(42) And #myhl(men)[Joshua] captured all these kings and their land at one time, because the #myhl(divine)[#smallcaps[Lord] God of Israel] fought for #myname[Israel]. 
#versenum(43) Then #myhl(men)[Joshua] returned, and all #myname[Israel] with him, to the camp at #myhl(places)[Gilgal].
...
#versenum(3) to the #myname[Canaanites] in the east and the west, the #myname[Amorites], the #myname[Hittites], the #myname[Perizzites], and the #myname[Jebusites] in the hill country, and the #myname[Hivites] under #myhl(places)[Hermon] in the land of #myhl(places)[Mizpah]. 
...
#versenum(5) And all these kings #underline[joined] their forces and came and encamped together at the waters of #myhl(places)[Merom] to fight against #myname[Israel].


  
#versenum(6) And the #myhl(divine)[#smallcaps[Lord]] said to #myhl(men)[Joshua], “Do not be afraid of them, for tomorrow at this time I will give over all of them, slain, to #myname[Israel]. You shall #underline[hamstring] their horses and burn their chariots with fire.” 
...
#versenum(8) And the #myhl(divine)[#smallcaps[Lord]] gave them into the hand of #myname[Israel], who struck them and chased them as far as Great #myhl(places)[Sidon] and #myhl(places)[Misrephoth-maim], and eastward as far as the #myhl(places)[Valley of Mizpeh]. And they struck them until he left none remaining. 
...
#versenum(13) But none of the cities that stood on #underline[mounds] did #myname[Israel] burn, except #myhl(places)[Hazor] alone; that #myhl(men)[Joshua] burned. 
...
#versenum(19) There was not a city that made peace with the people of #myname[Israel] except the #myname[Hivites], the inhabitants of #myhl(places)[Gibeon]. They took them all in battle. 
#versenum(20) For it was the #myhl(divine)[#smallcaps[Lord]]’s doing to #underline[harden] their hearts that they should come against #myname[Israel] in battle, in order that they should be devoted to destruction and should #underline[receive] no #underline[mercy] but be destroyed, just as the #myhl(divine)[#smallcaps[Lord]] commanded #myhl(men)[Moses].


  
#versenum(21) And #myhl(men)[Joshua] came at that time and cut off the #myname[Anakim] from the hill country, from #myhl(places)[Hebron], from #myhl(places)[Debir], from #myhl(places)[Anab], and from all #myhl(places)[the hill country of Judah], and from all #myhl(places)[the hill country of Israel]. #myhl(men)[Joshua] devoted them to destruction with their cities. 
#versenum(22) There was none of the #myname[Anakim] left in the land of the people of #myname[Israel]. Only in #myhl(places)[Gaza], in Gath, and in #myhl(places)[Ashdod] did some remain. 
#versenum(23) So #myhl(men)[Joshua] took the whole land, according to all that the #myhl(divine)[#smallcaps[Lord]] had spoken to #myhl(men)[Moses]. And #myhl(men)[Joshua] gave it for an inheritance to #myname[Israel] according to their tribal allotments. And the land had rest from war.
...
#versenum(1) Now these are the kings of the land whom the people of #myname[Israel] defeated and took possession of their land beyond the #myhl(places)[Jordan] toward the sunrise, from the #myhl(places)[Valley of the Arnon] to #myhl(places)[Mount Hermon], with all the #myhl(places)[Arabah] eastward: 
#versenum(2) #myhl(men)[Sihon] king of the #myname[Amorites] who lived at #myhl(places)[Heshbon] and ruled from #myhl(places)[Aroer], which is on the edge of the #myhl(places)[Valley of the Arnon], and from the middle of the valley as far as the river #myhl(places)[Jabbok], the boundary of the #myname[Ammonites], that is, #mynumber[half] of #myhl(places)[Gilead], 
...
#versenum(4) and #myhl(men)[Og]#footnote[Joshua 12:4 Septuagint; Hebrew #emph[the boundary of Og]] king of #myhl(places)[Bashan], one of the remnant of the #myname[Rephaim], who lived at #myhl(places)[Ashtaroth] and at #myhl(places)[Edrei] 
#versenum(5) and ruled over #myhl(places)[Mount Hermon] and #myhl(places)[Salecah] and all #myhl(places)[Bashan] to the boundary of the #myname[Geshurites] and the #myname[Maacathites], and over #mynumber[half] of #myhl(places)[Gilead] to the boundary of #myhl(men)[Sihon] king of #myhl(places)[Heshbon]. 
#versenum(6) #myhl(men)[Moses], the servant of the #myhl(divine)[#smallcaps[Lord]], and the people of #myname[Israel] defeated them. And #myhl(men)[Moses] the servant of the #myhl(divine)[#smallcaps[Lord]] gave their land for a possession to the #myname[Reubenites] and the #myname[Gadites] and the #mynumber[half]-tribe of #myname[Manasseh].
...
#versenum(7) And these are the kings of the land whom #myhl(men)[Joshua] and the people of #myname[Israel] defeated on the west side of the #myhl(places)[Jordan], from #myhl(places)[Baal-gad] in the #myhl(places)[Valley of Lebanon] to #myhl(places)[Mount Halak], that rises toward #myhl(places)[Seir] (and #myhl(men)[Joshua] gave their land to the tribes of #myname[Israel] as a possession according to their allotments, 
#versenum(8) in the hill country, in the lowland, in the #myhl(places)[Arabah], in the slopes, in the wilderness, and in the #myhl(places)[Negeb], the land of the #myname[Hittites], the #myname[Amorites], the #myname[Canaanites], the #myname[Perizzites], the #myname[Hivites], and the #myname[Jebusites]): 
#versenum(9) the king of #myhl(places)[Jericho], #mynumber[one]; the king of #myhl(places)[Ai], which is beside #myhl(places)[Bethel], #mynumber[one]; 
#versenum(10) the king of #myhl(places)[Jerusalem], #mynumber[one]; the king of #myhl(places)[Hebron], #mynumber[one]; 
#versenum(11) the king of #myhl(places)[Jarmuth], #mynumber[one]; the king of #myhl(places)[Lachish], #mynumber[one]; 
#versenum(12) the king of #myhl(places)[Eglon], #mynumber[one]; the king of #myhl(places)[Gezer], #mynumber[one]; 
#versenum(13) the king of #myhl(places)[Debir], #mynumber[one]; the king of #underline[#myhl(places)[Geder]], #mynumber[one]; 
#versenum(14) the king of #myhl(places)[Hormah], #mynumber[one]; the king of #myhl(places)[Arad], #mynumber[one]; 
#versenum(15) the king of #myhl(places)[Libnah], #mynumber[one]; the king of #myhl(places)[Adullam], #mynumber[one]; 
#versenum(16) the king of #myhl(places)[Makkedah], #mynumber[one]; the king of #myhl(places)[Bethel], #mynumber[one]; 
#versenum(17) the king of #myhl(places)[Tappuah], #mynumber[one]; the king of #myhl(places)[Hepher], #mynumber[one]; 
#versenum(18) the king of #myhl(places)[Aphek], #mynumber[one]; the king of #underline[#myhl(places)[Lasharon]], #mynumber[one]; 
#versenum(19) the king of #myhl(places)[Madon], #mynumber[one]; the king of #myhl(places)[Hazor], #mynumber[one]; 
#versenum(20) the king of #underline[#myhl(places)[Shimron-meron]], #mynumber[one]; the king of #myhl(places)[Achshaph], #mynumber[one]; 
#versenum(21) the king of #myhl(places)[Taanach], #mynumber[one]; the king of #myhl(places)[Megiddo], #mynumber[one]; 
#versenum(22) the king of #myhl(places)[Kedesh], #mynumber[one]; the king of #myhl(places)[Jokneam] in #myhl(places)[Carmel], #mynumber[one]; 
#versenum(23) the king of #myhl(places)[Dor] in #underline[#myhl(places)[Naphath-dor]], #mynumber[one]; the king of #underline[#myhl(places)[Goiim]] in #myhl(places)[Galilee],#footnote[Joshua 12:23 Septuagint; Hebrew #emph[Gilgal]] #mynumber[one]; 
#versenum(24) the king of #myhl(places)[Tirzah], #mynumber[one]: in all, #underline[#mynumber[thirty-one]] kings.
...
#versenum(3) (from the #underline[#myhl(places)[Shihor]], which is east of #myhl(places)[Egypt], northward to the boundary of #myhl(places)[Ekron], it is counted as #underline[#myname[Canaanite]]; there are #mynumber[five] rulers of the #myname[Philistines], those of #myhl(places)[Gaza], #myhl(places)[Ashdod], #myhl(places)[Ashkelon], Gath, and #myhl(places)[Ekron]), and those of the #myname[Avvim], 
#versenum(4) in the south, all the land of the #myname[Canaanites], and #underline[#myhl(places)[Mearah]] that belongs to the #myname[Sidonians], to #myhl(places)[Aphek], to the boundary of the #myname[Amorites], 
#versenum(5) and the land of the #underline[#myname[Gebalites]], and all #myhl(places)[Lebanon], toward the sunrise, from #myhl(places)[Baal-gad] below #myhl(places)[Mount Hermon] to #myhl(places)[Lebo-hamath], 
#versenum(6) all the inhabitants of the hill country from #myhl(places)[Lebanon] to #myhl(places)[Misrephoth-maim], even all the #myname[Sidonians]. I myself will drive them out from before the people of #myname[Israel]. Only #underline[allot] the land to #myname[Israel] for an inheritance, as I have commanded you. 
...
#versenum(8) With the other #mynumber[half] of the tribe of #myname[Manasseh]#footnote[Joshua 13:8 Hebrew #emph[With it]] the #myname[Reubenites] and the #myname[Gadites] received their inheritance, which #myhl(men)[Moses] gave them, beyond the #myhl(places)[Jordan] eastward, as #myhl(men)[Moses] the servant of the #myhl(divine)[#smallcaps[Lord]] gave them: 
...
#versenum(10) and all the cities of #myhl(men)[Sihon] king of the #myname[Amorites], who reigned in #myhl(places)[Heshbon], as far as the boundary of the #myname[Ammonites]; 
#versenum(11) and #myhl(places)[Gilead], and the region of the #myname[Geshurites] and #myname[Maacathites], and all #myhl(places)[Mount Hermon], and all #myhl(places)[Bashan] to #myhl(places)[Salecah]; 
#versenum(12) all the kingdom of #myhl(men)[Og] in #myhl(places)[Bashan], who reigned in #myhl(places)[Ashtaroth] and in #myhl(places)[Edrei] (he alone was left of the remnant of the #myname[Rephaim]); these #myhl(men)[Moses] had struck and driven out. 
#versenum(13) Yet the people of #myname[Israel] did not drive out the #myname[Geshurites] or the #myname[Maacathites], but #underline[#myhl(places)[Geshur]] and #underline[#myhl(places)[Maacath]] dwell in the midst of #myname[Israel] to this day.


  
#versenum(14) To the tribe of #myname[Levi] alone #myhl(men)[Moses] gave no inheritance. The offerings by fire to the #myhl(divine)[#smallcaps[Lord] God of Israel] are their inheritance, as he said to him.


  
#versenum(15) And #myhl(men)[Moses] gave an inheritance to the tribe of the people of #myname[Reuben] according to their clans. 
...
#versenum(21) that is, all the cities of the tableland, and all the kingdom of #myhl(men)[Sihon] king of the #myname[Amorites], who reigned in #myhl(places)[Heshbon], whom #myhl(men)[Moses] defeated with the leaders of #myname[Midian], #underline[#myhl(men)[Evi]] and #myhl(men)[Rekem] and #underline[#myhl(men)[Zur]] and #underline[#myhl(men)[Hur]] and #underline[#myhl(men)[Reba]], the princes of #myhl(men)[Sihon], who lived in the land. 
#versenum(22) #myhl(men)[Balaam] also, the son of #myhl(men)[Beor], the one who #underline[practiced] #underline[divination], was killed with the sword by the people of #myname[Israel] among the rest of their slain. 
#versenum(23) And the border of the people of #myname[Reuben] was the #myhl(places)[Jordan] as a boundary. This was the inheritance of the people of #myname[Reuben], according to their clans with their cities and villages.


  
#versenum(24) #myhl(men)[Moses] gave an inheritance also to the tribe of #myname[Gad], to the people of #myname[Gad], according to their clans. 
#versenum(25) Their territory was #myhl(places)[Jazer], and all the cities of #myhl(places)[Gilead], and #mynumber[half] the land of the #myname[Ammonites], to #myhl(places)[Aroer], which is east of #myhl(places)[Rabbah], 
...
#versenum(29) And #myhl(men)[Moses] gave an inheritance to the #mynumber[half]-tribe of #myname[Manasseh]. It was allotted to the #mynumber[half]-tribe of the people of #myname[Manasseh] according to their clans. 
#versenum(30) Their region #underline[extended] from #myhl(places)[Mahanaim], through all #myhl(places)[Bashan], the whole kingdom of #myhl(men)[Og] king of #myhl(places)[Bashan], and all the towns of #myhl(men)[Jair], which are in #myhl(places)[Bashan], #underline[#mynumber[sixty]] cities, 
#versenum(31) and #mynumber[half] #myhl(places)[Gilead], and #myhl(places)[Ashtaroth], and #myhl(places)[Edrei], the cities of the kingdom of #myhl(men)[Og] in #myhl(places)[Bashan]. These were allotted to the people of #myhl(men)[Machir] the son of #myhl(men)[Manasseh] for the #mynumber[half] of the people of #myhl(men)[Machir] according to their clans.
...
#versenum(33) But to the tribe of #myname[Levi] #myhl(men)[Moses] gave no inheritance; the #myhl(divine)[#smallcaps[Lord] God of Israel] is their inheritance, just as he said to them.
...
#versenum(1) These are the inheritances that the people of #myname[Israel] received in the land of #myhl(places)[Canaan], which #myhl(men)[Eleazar] the priest and #myhl(men)[Joshua] the son of #myhl(men)[Nun] and the heads of the fathers’ houses of the tribes of the people of #myname[Israel] gave them to inherit. 
#versenum(2) Their inheritance was by lot, just as the #myhl(divine)[#smallcaps[Lord]] had commanded by the hand of #myhl(men)[Moses] for the #mynumber[nine and one-half] tribes. 
#versenum(3) For #myhl(men)[Moses] had given an inheritance to the #mynumber[two and one-half] tribes beyond the #myhl(places)[Jordan], but to the #myname[Levites] he gave no inheritance among them. 
...
#versenum(5) The people of #myname[Israel] did as the #myhl(divine)[#smallcaps[Lord]] commanded #myhl(men)[Moses]; they allotted the land.
...
#versenum(6) Then the people of #myname[Judah] came to #myhl(men)[Joshua] at #myhl(places)[Gilgal]. And #myhl(men)[Caleb] the son of #myhl(men)[Jephunneh] the #myname[Kenizzite] said to him, “You know what the #myhl(divine)[#smallcaps[Lord]] said to #myhl(men)[Moses] the man of #myhl(divine)[God] in #myhl(places)[Kadesh-barnea] concerning you and me. 
#versenum(7) I was #mynumber[forty] years old when #myhl(men)[Moses] the servant of the #myhl(divine)[#smallcaps[Lord]] sent me from #myhl(places)[Kadesh-barnea] to spy out the land, and I brought him word again as it was in my heart. 
...
#versenum(10) And now, behold, the #myhl(divine)[#smallcaps[Lord]] has kept me alive, just as he said, these #underline[#mynumber[forty-five]] years since the time that the #myhl(divine)[#smallcaps[Lord]] spoke this word to #myhl(men)[Moses], while #myname[Israel] walked in the wilderness. And now, behold, I am this day #underline[#mynumber[eighty-five]] years old. 
...
#versenum(12) So now give me this hill country of which the #myhl(divine)[#smallcaps[Lord]] spoke on that day, for you heard on that day how the #myname[Anakim] were there, with great fortified cities. It may be that the #myhl(divine)[#smallcaps[Lord]] will be with me, and I shall drive them out just as the #myhl(divine)[#smallcaps[Lord]] said.”
...
#versenum(14) Therefore #myhl(places)[Hebron] became the inheritance of #myhl(men)[Caleb] the son of #myhl(men)[Jephunneh] the #myname[Kenizzite] to this day, because he wholly followed the #myhl(divine)[#smallcaps[Lord], the God of Israel]. 
#versenum(15) Now the name of #myhl(places)[Hebron] formerly was #myhl(places)[Kiriath-arba].#footnote[Joshua 14:15 #emph[Kiriath-arba] means #emph[the city of Arba]] (#myhl(men)[Arba]#footnote[Joshua 14:15 Hebrew #emph[He]] was the #underline[greatest] man among the #myname[Anakim].) And the land had rest from war.
...
#versenum(1) The allotment for the tribe of the people of #myname[Judah] according to their clans reached southward to the boundary of #myhl(places)[Edom], to the wilderness of #myhl(places)[Zin] at the farthest south. 
...
#versenum(8) Then the boundary goes up by the #myhl(places)[Valley of the Son of Hinnom] at the southern shoulder of the #underline[#myname[Jebusite]] (that is, #myhl(places)[Jerusalem]). And the boundary goes up to the top of the mountain that lies over against the #myhl(places)[Valley of Hinnom], on the west, at the northern end of the #myhl(places)[Valley of Rephaim]. 
...
#versenum(12) And the west boundary was the #myhl(places)[Great Sea] with its coastline. This is the boundary around the people of #myname[Judah] according to their clans.


  
#versenum(13) According to the commandment of the #myhl(divine)[#smallcaps[Lord]] to #myhl(men)[Joshua], he gave to #myhl(men)[Caleb] the son of #myhl(men)[Jephunneh] a portion among the people of #myname[Judah], #myhl(places)[Kiriath-arba], that is, #myhl(places)[Hebron] (#myhl(men)[Arba] was the father of #myhl(men)[Anak]). 
#versenum(14) And #myhl(men)[Caleb] drove out from there the #mynumber[three] sons of #myhl(men)[Anak], #myhl(men)[Sheshai] and #myhl(men)[Ahiman] and #myhl(men)[Talmai], the descendants of #myhl(men)[Anak]. 
...
#versenum(21) The cities belonging to the tribe of the people of #myname[Judah] in the #underline[extreme] south, toward the boundary of #myhl(places)[Edom], were #underline[#myhl(places)[Kabzeel]], #underline[#myhl(places)[Eder]], #underline[#myhl(places)[Jagur]], 
...
#versenum(32) #underline[#myhl(places)[Lebaoth]], #underline[#myhl(places)[Shilhim]], #myhl(places)[Ain], and #myhl(places)[Rimmon]: in all, #underline[#mynumber[twenty-nine]] cities with their villages.
...
#versenum(36) #underline[#myhl(places)[Shaaraim]], #underline[#myhl(places)[Adithaim]], #underline[#myhl(places)[Gederah]], #underline[#myhl(places)[Gederothaim]]: #mynumber[fourteen] cities with their villages.
...
#versenum(41) #underline[#myhl(places)[Gederoth]], #myhl(places)[Beth-dagon], #underline[#myhl(places)[Naamah]], and #myhl(places)[Makkedah]: #mynumber[sixteen] cities with their villages.
...
#versenum(44) #underline[#myhl(places)[Keilah]], #myhl(places)[Achzib], and #underline[#myhl(places)[Mareshah]]: #mynumber[nine] cities with their villages.
...
#versenum(51) #myhl(places)[Goshen], #myhl(places)[Holon], and #underline[#myhl(places)[Giloh]]: #underline[#mynumber[eleven]] cities with their villages.
...
#versenum(54) #underline[#myhl(places)[Humtah]], #myhl(places)[Kiriath-arba] (that is, #myhl(places)[Hebron]), and #underline[#myhl(places)[Zior]]: #mynumber[nine] cities with their villages.
...
#versenum(57) #underline[#myhl(places)[Kain]], #myhl(places)[Gibeah], and #myhl(places)[Timnah]: #mynumber[ten] cities with their villages.


  
#versenum(58) #underline[#myhl(places)[Halhul]], #underline[#myhl(places)[Beth-zur]], #underline[#myhl(places)[Gedor]], 
#versenum(59) #underline[#myhl(places)[Maarath]], #underline[#myhl(places)[Beth-anoth]], and #underline[#myhl(places)[Eltekon]]: #mynumber[six] cities with their villages.


  
#versenum(60) #myhl(places)[Kiriath-baal] (that is, #myhl(places)[Kiriath-jearim]), and #myhl(places)[Rabbah]: #mynumber[two] cities with their villages.


  
#versenum(61) In the wilderness, #myhl(places)[Beth-arabah], #underline[#myhl(places)[Middin]], #underline[#myhl(places)[Secacah]], 
#versenum(62) #underline[#myhl(places)[Nibshan]], the #myhl(places)[City of Salt], and #underline[#myhl(places)[Engedi]]: #mynumber[six] cities with their villages.


  
#versenum(63) But the #myname[Jebusites], the inhabitants of #myhl(places)[Jerusalem], the people of #myname[Judah] could not drive out, so the #myname[Jebusites] dwell with the people of #myname[Judah] at #myhl(places)[Jerusalem] to this day.
...
#versenum(1) The allotment of the people of #myname[Joseph] went from the #myhl(places)[Jordan] by #myhl(places)[Jericho], east of the waters of #myhl(places)[Jericho], into the wilderness, going up from #myhl(places)[Jericho] into the hill country to #myhl(places)[Bethel]. 
#versenum(2) Then going from #myhl(places)[Bethel] to #myhl(places)[Luz], it passes along to #myhl(places)[Ataroth], the territory of the #underline[#myname[Archites]]. 
#versenum(3) Then it goes down westward to the territory of the #underline[#myname[Japhletites]], as far as the territory of #myhl(places)[Lower Beth-horon], then to #myhl(places)[Gezer], and it ends at the sea.
...
#versenum(5) The territory of the people of #myname[Ephraim] by their clans was as #underline[follows]: the boundary of their inheritance on the east was #myhl(places)[Ataroth-addar] as far as #myhl(places)[Upper Beth-horon], 
...
#versenum(8) From #myhl(places)[Tappuah] the boundary goes westward to the brook #myhl(places)[Kanah] and ends at the sea. Such is the inheritance of the tribe of the people of #myname[Ephraim] by their clans, 
...
#versenum(10) #underline[However], they did not drive out the #myname[Canaanites] who lived in #myhl(places)[Gezer], so the #myname[Canaanites] have lived in the midst of #myname[Ephraim] to this day but have been made to do forced labor.
...
#versenum(1) Then allotment was made to the people of #myname[Manasseh], for he was the firstborn of #myhl(men)[Joseph]. To #myhl(men)[Machir] the firstborn of #myhl(men)[Manasseh], the father of #myhl(men)[Gilead], were allotted #myhl(places)[Gilead] and #myhl(places)[Bashan], because he was a man of war. 
#versenum(2) And allotments were made to the rest of the people of #myname[Manasseh] by their clans, #myhl(men)[Abiezer], #underline[#myhl(men)[Helek]], #underline[#myhl(men)[Asriel]], #myhl(men)[Shechem], #myhl(men)[Hepher], and #underline[#myhl(men)[Shemida]]. These were the male descendants of #myhl(men)[Manasseh] the son of #myhl(men)[Joseph], by their clans.
...
#versenum(5) Thus there fell to #myname[Manasseh] #mynumber[ten] portions, besides the land of #myhl(places)[Gilead] and #myhl(places)[Bashan], which is on the other side of the #myhl(places)[Jordan], 
#versenum(6) because the daughters of #myname[Manasseh] received an inheritance along with his sons. The land of #myhl(places)[Gilead] was allotted to the rest of the people of #myname[Manasseh].
...
#versenum(8) The land of #myhl(places)[Tappuah] belonged to #myname[Manasseh], but the town of #myhl(places)[Tappuah] on the boundary of #myhl(places)[Manasseh] belonged to the people of #myname[Ephraim]. 
#versenum(9) Then the boundary went down to the brook #myhl(places)[Kanah]. These cities, to the south of the brook, among the cities of #myhl(places)[Manasseh], belong to #myname[Ephraim]. Then the boundary of #myhl(places)[Manasseh] goes on the north side of the brook and ends at the sea, 
#versenum(10) the land to the south being #underline[#myname[Ephraim]’s] and that to the north being #underline[#myname[Manasseh]’s], with the sea #underline[forming] its boundary. On the north #myhl(places)[Asher] is reached, and on the east #myhl(places)[Issachar]. 
#versenum(11) Also in #myhl(places)[Issachar] and in #myhl(places)[Asher] #myname[Manasseh] had #myhl(places)[Beth-shean] and its villages, and #myhl(places)[Ibleam] and its villages, and the inhabitants of #myhl(places)[Dor] and its villages, and the inhabitants of #underline[#myhl(places)[En-dor]] and its villages, and the inhabitants of #myhl(places)[Taanach] and its villages, and the inhabitants of #myhl(places)[Megiddo] and its villages; the #mynumber[third] is #underline[#myhl(places)[Naphath]].#footnote[Joshua 17:11 The meaning of the Hebrew is uncertain] 
...
#versenum(14) Then the people of #myname[Joseph] spoke to #myhl(men)[Joshua], saying, “Why have you given me but one lot and one portion as an inheritance, although I am a numerous people, since all along the #myhl(divine)[#smallcaps[Lord]] has blessed me?” 
#versenum(15) And #myhl(men)[Joshua] said to them, “If you are a numerous people, go up by yourselves to the forest, and there clear ground for yourselves in the land of the #myname[Perizzites] and the #myname[Rephaim], since #myhl(places)[the hill country of Ephraim] is too #underline[narrow] for you.” 
#versenum(16) The people of #myname[Joseph] said, “The hill country is not enough for us. Yet all the #myname[Canaanites] who dwell in the plain have chariots of iron, both those in #myhl(places)[Beth-shean] and its villages and those in the #myhl(places)[Valley of Jezreel].” 
#versenum(17) Then #myhl(men)[Joshua] said to the house of #myname[Joseph], to #myname[Ephraim] and #myname[Manasseh], “You are a numerous people and have great power. You shall not have one allotment only, 
...
#versenum(1) Then the whole congregation of the people of #myname[Israel] assembled at #myhl(places)[Shiloh] and set up the tent of meeting there. The land lay subdued before them.
...
#versenum(3) So #myhl(men)[Joshua] said to the people of #myname[Israel], “How long will you put off going in to take possession of the land, which the #myhl(divine)[#smallcaps[Lord], the God] of your fathers, has given you? 
...
#versenum(6) And you shall #underline[describe] the land in #mynumber[seven] divisions and bring the description here to me. And I will cast lots for you here before the #myhl(divine)[#smallcaps[Lord]] our #myhl(divine)[God]. 
#versenum(7) The #myname[Levites] have no portion among you, for the #underline[priesthood] of the #myhl(divine)[#smallcaps[Lord]] is their #underline[heritage]. And #myname[Gad] and #myname[Reuben] and #mynumber[half] the tribe of #myname[Manasseh] have received their inheritance beyond the #myhl(places)[Jordan] eastward, which #myhl(men)[Moses] the servant of the #myhl(divine)[#smallcaps[Lord]] gave them.”
...
#versenum(9) So the men went and passed up and down in the land and wrote in a book a description of it by towns in #mynumber[seven] divisions. Then they came to #myhl(men)[Joshua] to the camp at #myhl(places)[Shiloh], 
#versenum(10) and #myhl(men)[Joshua] cast lots for them in #myhl(places)[Shiloh] before the #myhl(divine)[#smallcaps[Lord]]. And there #myhl(men)[Joshua] apportioned the land to the people of #myname[Israel], to each his portion.
...
#versenum(14) Then the boundary goes in another direction, turning on the western side southward from the mountain that lies to the south, opposite #myhl(places)[Beth-horon], and it ends at #myhl(places)[Kiriath-baal] (that is, #myhl(places)[Kiriath-jearim]), a city belonging to the people of #myname[Judah]. This forms the western side. 
...
#versenum(20) The #myhl(places)[Jordan] forms its boundary on the #underline[eastern] side. This is the inheritance of the people of #myname[Benjamin], according to their clans, boundary by boundary all around.


  
#versenum(21) Now the cities of the tribe of the people of #myname[Benjamin] according to their clans were #myhl(places)[Jericho], #myhl(places)[Beth-hoglah], #underline[#myhl(places)[Emek-keziz]], 
...
#versenum(24) #underline[#myhl(places)[Chephar-ammoni]], #underline[#myhl(places)[Ophni]], #myhl(places)[Geba]—#mynumber[twelve] cities with their villages: 
...
#versenum(28) #underline[#myhl(places)[Zela]], #underline[#myhl(places)[Haeleph]], #myhl(places)[Jebus]#footnote[Joshua 18:28 Septuagint, Syriac, Vulgate; Hebrew #emph[the Jebusite]] (that is, #myhl(places)[Jerusalem]), #myhl(places)[Gibeah]#footnote[Joshua 18:28 Hebrew #emph[Gibeath]] and #myhl(places)[Kiriath-jearim]#footnote[Joshua 18:28 Septuagint; Hebrew #emph[Kiriath]]—#mynumber[fourteen] cities with their villages. This is the inheritance of the people of #myname[Benjamin] according to its clans.
...
#versenum(6) #underline[#myhl(places)[Beth-lebaoth]], and #underline[#myhl(places)[Sharuhen]]—#mynumber[thirteen] cities with their villages; 
#versenum(7) #myhl(places)[Ain], #myhl(places)[Rimmon], #myhl(places)[Ether], and #myhl(places)[Ashan]—#mynumber[four] cities with their villages, 
#versenum(8) together with all the villages around these cities as far as #underline[#myhl(places)[Baalath-beer]], #myhl(places)[Ramah] of the #myhl(places)[Negeb]. This was the inheritance of the tribe of the people of #myname[Simeon] according to their clans. 
...
#versenum(10) The #mynumber[third] lot came up for the people of #myname[Zebulun], according to their clans. And the territory of their inheritance reached as far as #myhl(places)[Sarid]. 
...
#versenum(15) and #underline[#myhl(places)[Kattath]], #myhl(places)[Nahalal], #myhl(places)[Shimron], #underline[#myhl(places)[Idalah]], and #myhl(places)[Bethlehem]—#mynumber[twelve] cities with their villages. 
...
#versenum(22) The boundary also touches #myhl(places)[Tabor], #underline[#myhl(places)[Shahazumah]], and #myhl(places)[Beth-shemesh], and its boundary ends at the #myhl(places)[Jordan]—#mynumber[sixteen] cities with their villages. 
...
#versenum(27) then it turns eastward, it goes to #myhl(places)[Beth-dagon], and touches #myname[Zebulun] and the #myhl(places)[Valley of Iphtahel] northward to #underline[#myhl(places)[Beth-emek]] and #underline[#myhl(places)[Neiel]]. Then it #underline[continues] in the north to #underline[#myhl(places)[Cabul]], 
...
#versenum(30) #underline[#myhl(places)[Ummah]], #myhl(places)[Aphek] and #myhl(places)[Rehob]—#mynumber[twenty-two] cities with their villages. 
...
#versenum(34) Then the boundary turns westward to #underline[#myhl(places)[Aznoth-tabor]] and goes from there to #underline[#myhl(places)[Hukkok]], #underline[touching] #myname[Zebulun] at the south and #myname[Asher] on the west and #myname[Judah] on the east at the #myhl(places)[Jordan]. 
...
#versenum(38) #underline[#myhl(places)[Yiron]], #underline[#myhl(places)[Migdal-el]], #underline[#myhl(places)[Horem]], #myhl(places)[Beth-anath], and #myhl(places)[Beth-shemesh]—#underline[#mynumber[nineteen]] cities with their villages. 
...
#versenum(49) When they had finished #underline[distributing] the several #underline[territories] of the land as inheritances, the people of #myname[Israel] gave an inheritance among them to #myhl(men)[Joshua] the son of #myhl(men)[Nun]. 
...
#versenum(2) “Say to the people of #myname[Israel], ‘#underline[Appoint] the cities of refuge, of which I spoke to you through #myhl(men)[Moses], 
...
#versenum(8) And beyond the #myhl(places)[Jordan] east of #myhl(places)[Jericho], they appointed #myhl(places)[Bezer] in the wilderness on the tableland, from the tribe of #myname[Reuben], and #myhl(places)[Ramoth] in #myhl(places)[Gilead], from the tribe of #myname[Gad], and #myhl(places)[Golan] in #myhl(places)[Bashan], from the tribe of #myname[Manasseh]. 
...
#versenum(1) Then the heads of the fathers’ houses of the #myname[Levites] came to #myhl(men)[Eleazar] the priest and to #myhl(men)[Joshua] the son of #myhl(men)[Nun] and to the heads of the fathers’ houses of the tribes of the people of #myname[Israel]. 
...
#versenum(3) So by command of the #myhl(divine)[#smallcaps[Lord]] the people of #myname[Israel] gave to the #myname[Levites] the following cities and pasturelands out of their inheritance.


  
#versenum(4) The lot came out for the clans of the #myname[Kohathites]. So those #myname[Levites] who were descendants of #myhl(men)[Aaron] the priest received by lot from the tribes of #myname[Judah], #myname[Simeon], and #myname[Benjamin], #mynumber[thirteen] cities.
...
#versenum(6) The #myname[Gershonites] received by lot from the clans of the tribe of #myname[Issachar], from the tribe of #myname[Asher], from the tribe of #myname[Naphtali], and from the #mynumber[half]-tribe of #myname[Manasseh] in #myhl(places)[Bashan], #mynumber[thirteen] cities.
...
#versenum(8) These cities and their pasturelands the people of #myname[Israel] gave by lot to the #myname[Levites], as the #myhl(divine)[#smallcaps[Lord]] had commanded through #myhl(men)[Moses].
...
#versenum(10) which went to the descendants of #myhl(men)[Aaron], one of the clans of the #myname[Kohathites] who belonged to the people of #myname[Levi]; since the lot fell to them #mynumber[first]. 
...
#versenum(16) #myhl(places)[Ain] with its pasturelands, #myhl(places)[Juttah] with its pasturelands, #myhl(places)[Beth-shemesh] with its pasturelands—#mynumber[nine] cities out of these #mynumber[two] tribes; 
#versenum(17) then out of the tribe of #myname[Benjamin], #myhl(places)[Gibeon] with its pasturelands, #myhl(places)[Geba] with its pasturelands, 
#versenum(18) #underline[#myhl(places)[Anathoth]] with its pasturelands, and #underline[#myhl(places)[Almon]] with its pasturelands—#mynumber[four] cities. 
#versenum(19) The cities of the descendants of #myhl(men)[Aaron], the priests, were in all #mynumber[thirteen] cities with their pasturelands.
...
#versenum(22) #underline[#myname[Kibzaim]] with its pasturelands, #myhl(places)[Beth-horon] with its pasturelands—#mynumber[four] cities; 
#versenum(23) and out of the tribe of #myname[Dan], #underline[#myhl(places)[Elteke]] with its pasturelands, #myhl(places)[Gibbethon] with its pasturelands, 
#versenum(24) #myhl(places)[Aijalon] with its pasturelands, #myhl(places)[Gath-rimmon] with its pasturelands—#mynumber[four] cities; 
#versenum(25) and out of the #mynumber[half]-tribe of #myname[Manasseh], #myhl(places)[Taanach] with its pasturelands, and #myhl(places)[Gath-rimmon] with its pasturelands—#mynumber[two] cities. 
...
#versenum(27) And to the #myname[Gershonites], one of the clans of the #myname[Levites], were given out of the #mynumber[half]-tribe of #myname[Manasseh], #myhl(places)[Golan] in #myhl(places)[Bashan] with its pasturelands, the city of refuge for the manslayer, and #underline[#myhl(places)[Beeshterah]] with its pasturelands—#mynumber[two] cities; 
#versenum(28) and out of the tribe of #myname[Issachar], #myhl(places)[Kishion] with its pasturelands, #myhl(places)[Daberath] with its pasturelands, 
#versenum(29) #myhl(places)[Jarmuth] with its pasturelands, #myhl(places)[En-gannim] with its pasturelands—#mynumber[four] cities; 
#versenum(30) and out of the tribe of #myname[Asher], #myhl(places)[Mishal] with its pasturelands, #myhl(men)[Abdon] with its pasturelands, 
#versenum(31) #myhl(places)[Helkath] with its pasturelands, and #myhl(places)[Rehob] with its pasturelands—#mynumber[four] cities; 
#versenum(32) and out of the tribe of #myname[Naphtali], #myhl(places)[Kedesh] in #myhl(places)[Galilee] with its pasturelands, the city of refuge for the manslayer, #underline[#myhl(places)[Hammoth-dor]] with its pasturelands, and #underline[#myhl(places)[Kartan]] with its pasturelands—#mynumber[three] cities. 
...
#versenum(34) And to the rest of the #myname[Levites], the #myname[Merarite] clans, were given out of the tribe of #myname[Zebulun], #myhl(places)[Jokneam] with its pasturelands, #underline[#myhl(places)[Kartah]] with its pasturelands, 
#versenum(35) #underline[#myhl(places)[Dimnah]] with its pasturelands, #myhl(places)[Nahalal] with its pasturelands—#mynumber[four] cities; 
#versenum(36) and out of the tribe of #myname[Reuben], #myhl(places)[Bezer] with its pasturelands, #myhl(places)[Jahaz] with its pasturelands, 
#versenum(37) #myhl(places)[Kedemoth] with its pasturelands, and #myhl(places)[Mephaath] with its pasturelands—#mynumber[four] cities; 
#versenum(38) and out of the tribe of #myname[Gad], #myhl(places)[Ramoth] in #myhl(places)[Gilead] with its pasturelands, the city of refuge for the manslayer, #myhl(places)[Mahanaim] with its pasturelands, 
#versenum(39) #myhl(places)[Heshbon] with its pasturelands, #myhl(places)[Jazer] with its pasturelands—#mynumber[four] cities in all. 
...
#versenum(43) Thus the #myhl(divine)[#smallcaps[Lord]] gave to #myname[Israel] all the land that he swore to give to their fathers. And they took possession of it, and they settled there. 
...
#versenum(45) Not one word of all the good #underline[promises] that the #myhl(divine)[#smallcaps[Lord]] had made to the house of #myname[Israel] had failed; all came to pass.
...
#versenum(1) At that time #myhl(men)[Joshua] summoned the #myname[Reubenites] and the #myname[Gadites] and the #mynumber[half]-tribe of #myname[Manasseh], 
...
#versenum(7) Now to the one #mynumber[half] of the tribe of #myname[Manasseh] #myhl(men)[Moses] had given a possession in #myhl(places)[Bashan], but to the other #mynumber[half] #myhl(men)[Joshua] had given a possession beside their brothers in the land west of the #myhl(places)[Jordan]. And when #myhl(men)[Joshua] sent them away to their #underline[homes] and blessed them, 
...
#versenum(9) So the people of #myname[Reuben] and the people of #myname[Gad] and the #mynumber[half]-tribe of #myname[Manasseh] returned home, #underline[parting] from the people of #myname[Israel] at #myhl(places)[Shiloh], which is in the land of #myhl(places)[Canaan], to go to the land of #myhl(places)[Gilead], their own land of which they had #underline[possessed] themselves by command of the #myhl(divine)[#smallcaps[Lord]] through #myhl(men)[Moses].
...
#versenum(10) And when they came to the region of the #myhl(places)[Jordan] that is in the land of #myhl(places)[Canaan], the people of #myname[Reuben] and the people of #myname[Gad] and the #mynumber[half]-tribe of #myname[Manasseh] built there an altar by the #myhl(places)[Jordan], an altar of #underline[imposing] #underline[size]. 
#versenum(11) And the people of #myname[Israel] heard it said, “Behold, the people of #myname[Reuben] and the people of #myname[Gad] and the #mynumber[half]-tribe of #myname[Manasseh] have built the altar at the #underline[frontier] of the land of #myhl(places)[Canaan], in the region about the #myhl(places)[Jordan], on the side that belongs to the people of #myname[Israel].” 
#versenum(12) And when the people of #myname[Israel] heard of it, the whole assembly of the people of #myname[Israel] gathered at #myhl(places)[Shiloh] to make war against them.


  
#versenum(13) Then the people of #myname[Israel] sent to the people of #myname[Reuben] and the people of #myname[Gad] and the #mynumber[half]-tribe of #myname[Manasseh], in the land of #myhl(places)[Gilead], #myhl(men)[Phinehas] the son of #myhl(men)[Eleazar] the priest, 
...
#versenum(15) And they came to the people of #myname[Reuben], the people of #myname[Gad], and the #mynumber[half]-tribe of #myname[Manasseh], in the land of #myhl(places)[Gilead], and they said to them, 
...
#versenum(18) that you too must turn away this day from following the #myhl(divine)[#smallcaps[Lord]]? And if you too rebel against the #myhl(divine)[#smallcaps[Lord]] today then tomorrow he will be angry with the whole congregation of #myname[Israel]. 
...
#versenum(20) Did not #myhl(men)[Achan] the son of #myhl(men)[Zerah] break faith in the matter of the devoted things, and wrath fell upon all the congregation of #myname[Israel]? And he did not perish alone for his #underline[iniquity].’”
...
#versenum(22) “The Mighty One, #myhl(divine)[God], the #myhl(divine)[#smallcaps[Lord]]! The Mighty One, #myhl(divine)[God], the #myhl(divine)[#smallcaps[Lord]]! He #underline[knows]; and let #myname[Israel] itself know! If it was in rebellion or in breach of faith against the #myhl(divine)[#smallcaps[Lord]], do not #underline[spare] us today 
...
#versenum(25) For the #myhl(divine)[#smallcaps[Lord]] has made the #myhl(places)[Jordan] a boundary between us and you, you people of #myname[Reuben] and people of #myname[Gad]. You have no portion in the #myhl(divine)[#smallcaps[Lord]].’ So your children might make our children cease to #underline[worship] the #myhl(divine)[#smallcaps[Lord]]. 
...
#versenum(30) When #myhl(men)[Phinehas] the priest and the chiefs of the congregation, the heads of the families of #myname[Israel] who were with him, heard the words that the people of #myname[Reuben] and the people of #myname[Gad] and the people of #myname[Manasseh] spoke, it was good in their eyes. 
#versenum(31) And #myhl(men)[Phinehas] the son of #myhl(men)[Eleazar] the priest said to the people of #myname[Reuben] and the people of #myname[Gad] and the people of #myname[Manasseh], “Today we know that the #myhl(divine)[#smallcaps[Lord]] is in our midst, because you have not committed this breach of faith against the #myhl(divine)[#smallcaps[Lord]]. Now you have delivered the people of #myname[Israel] from the hand of the #myhl(divine)[#smallcaps[Lord]].”


  
#versenum(32) Then #myhl(men)[Phinehas] the son of #myhl(men)[Eleazar] the priest, and the chiefs, returned from the people of #myname[Reuben] and the people of #myname[Gad] in the land of #myhl(places)[Gilead] to the land of #myhl(places)[Canaan], to the people of #myname[Israel], and brought back word to them. 
#versenum(33) And the report was good in the eyes of the people of #myname[Israel]. And the people of #myname[Israel] blessed #myhl(divine)[God] and spoke no more of making war against them to destroy the land where the people of #myname[Reuben] and the people of #myname[Gad] were settled. 
#versenum(34) The people of #myname[Reuben] and the people of #myname[Gad] called the altar Witness, “For,” they said, “it is a witness between us that the #myhl(divine)[#smallcaps[Lord]] is #myhl(divine)[God].”
...
#versenum(1) A long time afterward, when the #myhl(divine)[#smallcaps[Lord]] had given rest to #myname[Israel] from all their surrounding enemies, and #myhl(men)[Joshua] was old and well advanced in years, 
#versenum(2) #myhl(men)[Joshua] summoned all #myname[Israel], its elders and heads, its judges and officers, and said to them, “I am now old and well advanced in years. 
...
#versenum(10) One man of you #underline[puts] to #underline[flight] a #mynumber[thousand], since it is the #myhl(divine)[#smallcaps[Lord] your God] who #underline[fights] for you, just as he promised you. 
...
#versenum(1) #myhl(men)[Joshua] gathered all the tribes of #myname[Israel] to #myhl(places)[Shechem] and summoned the elders, the heads, the judges, and the officers of #myname[Israel]. And they presented themselves before #myhl(divine)[God]. 
...
#versenum(6) “‘Then I brought your fathers out of #myhl(places)[Egypt], and you came to the sea. And the #myname[Egyptians] pursued your fathers with chariots and #underline[horsemen] to the #myhl(places)[Red Sea]. 
#versenum(7) And when they cried to the #myhl(divine)[#smallcaps[Lord]], he put #underline[darkness] between you and the #myname[Egyptians] and made the sea come upon them and #underline[cover] them; and your eyes saw what I did in #myhl(places)[Egypt]. And you lived in the wilderness a long time. 
#versenum(8) Then I brought you to the land of the #myname[Amorites], who lived on the other side of the #myhl(places)[Jordan]. They fought with you, and I gave them into your hand, and you took possession of their land, and I destroyed them before you. 
#versenum(9) Then #myhl(men)[Balak] the son of #myhl(men)[Zippor], king of #myhl(places)[Moab], arose and fought against #myname[Israel]. And he sent and invited #myhl(men)[Balaam] the son of #myhl(men)[Beor] to curse you, 
#versenum(10) but I would not listen to #myhl(men)[Balaam]. Indeed, he blessed you. So I delivered you out of his hand. 
#versenum(11) And you went over the #myhl(places)[Jordan] and came to #myhl(places)[Jericho], and the leaders of #myhl(places)[Jericho] fought against you, and also the #myname[Amorites], the #myname[Perizzites], the #myname[Canaanites], the #myname[Hittites], the #myname[Girgashites], the #myname[Hivites], and the #myname[Jebusites]. And I gave them into your hand. 
...
#versenum(18) And the #myhl(divine)[#smallcaps[Lord]] drove out before us all the peoples, the #myname[Amorites] who lived in the land. Therefore we also will serve the #myhl(divine)[#smallcaps[Lord]], for he is our #myhl(divine)[God].”
...
#versenum(29) After these things #myhl(men)[Joshua] the son of #myhl(men)[Nun], the servant of the #myhl(divine)[#smallcaps[Lord]], died, being #mynumber[110] years old. 
...
#versenum(31) #myname[Israel] served the #myhl(divine)[#smallcaps[Lord]] all the days of #myhl(men)[Joshua], and all the days of the elders who outlived #myhl(men)[Joshua] and had known all the work that the #myhl(divine)[#smallcaps[Lord]] did for #myname[Israel].


  
#versenum(32) As for the #underline[bones] of #myname[Joseph], which the people of #myname[Israel] brought up from #myhl(places)[Egypt], they buried them at #myhl(places)[Shechem], in the #underline[piece] of land that #myhl(men)[Jacob] bought from the sons of #myhl(men)[Hamor] the father of #myhl(places)[Shechem] for a #mynumber[hundred] pieces of money.#footnote[Joshua 24:32 Hebrew #emph[for a hundred qesitah]; a unit of money of uncertain value] It became an inheritance of the descendants of #myname[Joseph].
...
#versenum(1) After the death of #myhl(men)[Joshua], the people of #myname[Israel] inquired of the #myhl(divine)[#smallcaps[Lord]], “Who shall go up #mynumber[first] for us against the #myname[Canaanites], to fight against them?” 
#versenum(2) The #myhl(divine)[#smallcaps[Lord]] said, “#myname[Judah] shall go up; behold, I have given the land into his hand.” 
...
#versenum(4) Then #myname[Judah] went up and the #myhl(divine)[#smallcaps[Lord]] gave the #myname[Canaanites] and the #myname[Perizzites] into their hand, and they defeated #mynumber[10,000] of them at #myhl(places)[Bezek]. 
#versenum(5) They found #myhl(men)[Adoni-bezek] at #myhl(places)[Bezek] and fought against him and defeated the #myname[Canaanites] and the #myname[Perizzites]. 
#versenum(6) #myhl(men)[Adoni-bezek] fled, but they pursued him and caught him and cut off his thumbs and his big toes. 
#versenum(7) And #myhl(men)[Adoni-bezek] said, “#mynumber[Seventy] kings with their thumbs and their big toes cut off used to #underline[pick] up #underline[scraps] under my #underline[table]. As I have done, so #myhl(divine)[God] has #underline[repaid] me.” And they brought him to #myhl(places)[Jerusalem], and he died there.


  
#versenum(8) And the men of #myname[Judah] fought against #myhl(places)[Jerusalem] and captured it and struck it with the edge of the sword and set the city on fire. 
#versenum(9) And afterward the men of #myname[Judah] went down to fight against the #myname[Canaanites] who lived in the hill country, in the #myhl(places)[Negeb], and in the lowland. 
#versenum(10) And #myname[Judah] went against the #myname[Canaanites] who lived in #myhl(places)[Hebron] (now the name of #myhl(places)[Hebron] was formerly #myhl(places)[Kiriath-arba]), and they defeated #myhl(men)[Sheshai] and #myhl(men)[Ahiman] and #myhl(men)[Talmai].
...
#versenum(16) And the descendants of the #myname[Kenite], #myhl(men)[Moses]’ father-in-law, went up with the people of #myname[Judah] from the city of palms into the wilderness of #myname[Judah], which lies in the #myhl(places)[Negeb] near #myhl(places)[Arad], and they went and settled with the people. 
#versenum(17) And #myname[Judah] went with #myname[Simeon] his brother, and they defeated the #myname[Canaanites] who inhabited #underline[#myhl(places)[Zephath]] and devoted it to destruction. So the name of the city was called #myhl(places)[Hormah].#footnote[Judges 1:17 #emph[Hormah] means #emph[utter destruction]] 
#versenum(18) #myname[Judah] also captured #myhl(places)[Gaza] with its territory, and #myhl(places)[Ashkelon] with its territory, and #myhl(places)[Ekron] with its territory. 
#versenum(19) And the #myhl(divine)[#smallcaps[Lord]] was with #myname[Judah], and he took possession of the hill country, but he could not drive out the inhabitants of the plain because they had chariots of iron. 
#versenum(20) And #myhl(places)[Hebron] was given to #myhl(men)[Caleb], as #myhl(men)[Moses] had said. And he drove out from it the #mynumber[three] sons of #myhl(men)[Anak]. 
#versenum(21) But the people of #myname[Benjamin] did not drive out the #myname[Jebusites] who lived in #myhl(places)[Jerusalem], so the #myname[Jebusites] have lived with the people of #myname[Benjamin] in #myhl(places)[Jerusalem] to this day.


  
#versenum(22) The house of #myname[Joseph] also went up against #myhl(places)[Bethel], and the #myhl(divine)[#smallcaps[Lord]] was with them. 
#versenum(23) And the house of #myname[Joseph] #underline[scouted] out #myhl(places)[Bethel]. (Now the name of the city was formerly #myhl(places)[Luz].) 
...
#versenum(26) And the man went to the land of the #myname[Hittites] and built a city and called its name #myhl(places)[Luz]. That is its name to this day.
...
#versenum(29) And #myname[Ephraim] did not drive out the #myname[Canaanites] who lived in #myhl(places)[Gezer], so the #myname[Canaanites] lived in #myhl(places)[Gezer] among them.


  
#versenum(30) #myname[Zebulun] did not drive out the inhabitants of #underline[#myhl(places)[Kitron]], or the inhabitants of #underline[#myhl(places)[Nahalol]], so the #myname[Canaanites] lived among them, but became subject to forced labor.


  
#versenum(31) #myname[Asher] did not drive out the inhabitants of #underline[#myhl(places)[Acco]], or the inhabitants of #myhl(places)[Sidon] or of #underline[#myhl(places)[Ahlab]] or of #myhl(places)[Achzib] or of #underline[#myhl(places)[Helbah]] or of #underline[#myhl(places)[Aphik]] or of #myhl(places)[Rehob], 
...
#versenum(33) #myname[Naphtali] did not drive out the inhabitants of #myhl(places)[Beth-shemesh], or the inhabitants of #myhl(places)[Beth-anath], so they lived among the #myname[Canaanites], the inhabitants of the land. Nevertheless, the inhabitants of #myhl(places)[Beth-shemesh] and of #myhl(places)[Beth-anath] became subject to forced labor for them.
...
#versenum(35) The #myname[Amorites] persisted in dwelling in #myhl(places)[Mount Heres], in #myhl(places)[Aijalon], and in #underline[#myhl(places)[Shaalbim]], but the hand of the house of #myname[Joseph] rested #underline[heavily] on them, and they became subject to forced labor. 
#versenum(36) And the border of the #myname[Amorites] ran from the ascent of #myhl(places)[Akrabbim], from #underline[#myhl(places)[Sela]] and #underline[upward].
...
#versenum(4) As soon as the #myhl(divine)[angel of the #smallcaps[Lord]] spoke these words to all the people of #myname[Israel], the people lifted up their voices and wept. 
...
#versenum(6) When #myhl(men)[Joshua] #underline[dismissed] the people, the people of #myname[Israel] went each to his inheritance to take possession of the land. 
#versenum(7) And the people served the #myhl(divine)[#smallcaps[Lord]] all the days of #myhl(men)[Joshua], and all the days of the elders who outlived #myhl(men)[Joshua], who had seen all the great work that the #myhl(divine)[#smallcaps[Lord]] had done for #myname[Israel]. 
#versenum(8) And #myhl(men)[Joshua] the son of #myhl(men)[Nun], the servant of the #myhl(divine)[#smallcaps[Lord]], died at the age of #mynumber[110] years. 
...
#versenum(10) And all that generation also were gathered to their fathers. And there arose another generation after them who did not know the #myhl(divine)[#smallcaps[Lord]] or the work that he had done for #myname[Israel].
...
#versenum(11) And the people of #myname[Israel] did what was evil in the sight of the #myhl(divine)[#smallcaps[Lord]] and served the #myname[Baals]. 
...
#versenum(13) They abandoned the #myhl(divine)[#smallcaps[Lord]] and served the #myname[Baals] and the #myname[Ashtaroth]. 
#versenum(14) So the anger of the #myhl(divine)[#smallcaps[Lord]] was kindled against #myname[Israel], and he gave them over to #underline[plunderers], who plundered them. And he sold them into the hand of their surrounding enemies, so that they could no longer #underline[withstand] their enemies. 
...
#versenum(20) So the anger of the #myhl(divine)[#smallcaps[Lord]] was kindled against #myname[Israel], and he said, “Because this people have transgressed my covenant that I commanded their fathers and have not obeyed my voice, 
#versenum(21) I will no longer drive out before them any of the nations that #myhl(men)[Joshua] left when he died, 
#versenum(22) in order to test #myname[Israel] by them, whether they will take care to walk in the way of the #myhl(divine)[#smallcaps[Lord]] as their fathers did, or not.” 
...
#versenum(1) Now these are the nations that the #myhl(divine)[#smallcaps[Lord]] left, to test #myname[Israel] by them, that is, all in #myhl(places)[Israel] who had not #underline[experienced] all the #underline[wars] in #myhl(places)[Canaan]. 
...
#versenum(3) These are the nations: the #mynumber[five] lords of the #myname[Philistines] and all the #myname[Canaanites] and the #myname[Sidonians] and the #myname[Hivites] who lived on #myhl(places)[Mount Lebanon], from Mount #underline[#myhl(places)[Baal-hermon]] as far as #myhl(places)[Lebo-hamath]. 
#versenum(4) They were for the #underline[testing] of #myname[Israel], to know whether #myname[Israel] would obey the commandments of the #myhl(divine)[#smallcaps[Lord]], which he commanded their fathers by the hand of #myhl(men)[Moses]. 
...
#versenum(7) And the people of #myname[Israel] did what was evil in the sight of the #myhl(divine)[#smallcaps[Lord]]. They #underline[forgot] the #myhl(divine)[#smallcaps[Lord]] their #myhl(divine)[God] and served the #myname[Baals] and the #underline[#myname[Asheroth]]. 
#versenum(8) Therefore the anger of the #myhl(divine)[#smallcaps[Lord]] was kindled against #myname[Israel], and he sold them into the hand of #myhl(men)[Cushan-rishathaim] king of Mesopotamia. And the people of #myname[Israel] served #myhl(men)[Cushan-rishathaim] #mynumber[eight] years. 
#versenum(9) But when the people of #myname[Israel] cried out to the #myhl(divine)[#smallcaps[Lord]], the #myhl(divine)[#smallcaps[Lord]] raised up a deliverer for the people of #myname[Israel], who saved them, #myhl(men)[Othniel] the son of #myhl(men)[Kenaz], #myhl(men)[Caleb]’s younger brother. 
#versenum(10) The #myhl(divine)[Spirit] of the #myhl(divine)[#smallcaps[Lord]] was upon him, and he judged #myname[Israel]. He went out to war, and the #myhl(divine)[#smallcaps[Lord]] gave #myhl(men)[Cushan-rishathaim] king of Mesopotamia into his hand. And his hand #underline[prevailed] over #myhl(men)[Cushan-rishathaim]. 
#versenum(11) So the land had rest for #mynumber[forty] years. Then #myhl(men)[Othniel] the son of #myhl(men)[Kenaz] died.
...
#versenum(12) And the people of #myname[Israel] again did what was evil in the sight of the #myhl(divine)[#smallcaps[Lord]], and the #myhl(divine)[#smallcaps[Lord]] strengthened #myhl(men)[Eglon] the king of #myhl(places)[Moab] against #myname[Israel], because they had done what was evil in the sight of the #myhl(divine)[#smallcaps[Lord]]. 
...
#versenum(14) And the people of #myname[Israel] served #myhl(men)[Eglon] the king of #myhl(places)[Moab] #mynumber[eighteen] years.


  
#versenum(15) Then the people of #myname[Israel] cried out to the #myhl(divine)[#smallcaps[Lord]], and the #myhl(divine)[#smallcaps[Lord]] raised up for them a deliverer, #myhl(men)[Ehud], the son of #underline[#myhl(men)[Gera]], the #underline[#myname[Benjaminite]], a left-handed man. The people of #myname[Israel] sent tribute by him to #myhl(men)[Eglon] the king of #myhl(places)[Moab]. 
#versenum(16) And #myhl(men)[Ehud] made for himself a sword with #mynumber[two] #underline[edges], a #underline[cubit]#footnote[Judges 3:16 A #emph[cubit] was about 18 inches or 45 centimeters] in length, and he bound it on his right thigh under his clothes. 
...
#versenum(27) When he arrived, he sounded the trumpet in #myhl(places)[the hill country of Ephraim]. Then the people of #myname[Israel] went down with him from the hill country, and he was their leader. 
#versenum(28) And he said to them, “Follow after me, for the #myhl(divine)[#smallcaps[Lord]] has given your enemies the #myname[Moabites] into your hand.” So they went down after him and seized the fords of the #myhl(places)[Jordan] against the #myname[Moabites] and did not allow anyone to pass over. 
...
#versenum(30) So #myhl(places)[Moab] was subdued that day under the hand of #myname[Israel]. And the land had rest for #underline[#mynumber[eighty]] years.
...
#versenum(31) After him was #myhl(men)[Shamgar] the son of #myhl(men)[Anath], who killed #mynumber[600] of the #myname[Philistines] with an #underline[oxgoad], and he also saved #myname[Israel].
...
#versenum(1) And the people of #myname[Israel] again did what was evil in the sight of the #myhl(divine)[#smallcaps[Lord]] after #myhl(men)[Ehud] died. 
...
#versenum(3) Then the people of #myname[Israel] cried out to the #myhl(divine)[#smallcaps[Lord]] for help, for he had #mynumber[900] chariots of iron and he oppressed the people of #myname[Israel] #underline[cruelly] for #mynumber[twenty] years.


  
#versenum(4) Now #myhl(women)[Deborah], a #underline[prophetess], the wife of #underline[#myhl(men)[Lappidoth]], was #underline[judging] #myname[Israel] at that time. 
#versenum(5) She used to sit under the #underline[palm] of #myhl(women)[Deborah] between #myhl(places)[Ramah] and #myhl(places)[Bethel] in #myhl(places)[the hill country of Ephraim], and the people of #myname[Israel] came up to her for judgment. 
#versenum(6) She sent and summoned #myhl(men)[Barak] the son of #myhl(men)[Abinoam] from #underline[#myhl(places)[Kedesh-naphtali]] and said to him, “Has not the #myhl(divine)[#smallcaps[Lord], the God of Israel], commanded you, ‘Go, gather your men at #myhl(places)[Mount Tabor], taking #mynumber[10,000] from the people of #myname[Naphtali] and the people of #myname[Zebulun]. 
...
#versenum(10) And #myhl(men)[Barak] called out #myname[Zebulun] and #myname[Naphtali] to #myhl(places)[Kedesh]. And #mynumber[10,000] men went up at his heels, and #myhl(women)[Deborah] went up with him.


  
#versenum(11) Now #myhl(men)[Heber] the #myname[Kenite] had #underline[separated] from the #underline[#myname[Kenites]], the descendants of #underline[#myhl(men)[Hobab]] the father-in-law of #myhl(men)[Moses], and had #underline[pitched] his tent as far away as the oak in #myhl(places)[Zaanannim], which is near #myhl(places)[Kedesh].
...
#versenum(13) #myhl(men)[Sisera] called out all his chariots, #mynumber[900] chariots of iron, and all the men who were with him, from #myhl(places)[Harosheth-hagoyim] to the river #myhl(places)[Kishon]. 
#versenum(14) And #myhl(women)[Deborah] said to #myhl(men)[Barak], “Up! For this is the day in which the #myhl(divine)[#smallcaps[Lord]] has given #myhl(men)[Sisera] into your hand. Does not the #myhl(divine)[#smallcaps[Lord]] go out before you?” So #myhl(men)[Barak] went down from #myhl(places)[Mount Tabor] with #mynumber[10,000] men following him. 
...
#versenum(17) But #myhl(men)[Sisera] fled away on foot to the tent of #myhl(women)[Jael], the wife of #myhl(men)[Heber] the #myname[Kenite], for there was peace between #myhl(men)[Jabin] the king of #myhl(places)[Hazor] and the house of #myhl(men)[Heber] the #myname[Kenite]. 
...
#versenum(23) So on that day #myhl(divine)[God] subdued #myhl(men)[Jabin] the king of #myhl(places)[Canaan] before the people of #myname[Israel]. 
#versenum(24) And the hand of the people of #myname[Israel] pressed harder and harder against #myhl(men)[Jabin] the king of #myhl(places)[Canaan], until they destroyed #myhl(men)[Jabin] king of #myhl(places)[Canaan].
...
#versenum(8) When new gods were chosen,\
    ...
    #vin among #mynumber[forty thousand] in #myhl(places)[Israel]?\
...
#versenum(15) the princes of #myname[Issachar] came with #myhl(women)[Deborah],\
    #vin and #myname[Issachar] #underline[faithful] to #myhl(men)[Barak];\
...
#versenum(24) “Most blessed of women be #myhl(women)[Jael],\
    #vin the wife of #myhl(men)[Heber] the #myname[Kenite],\
...
#versenum(1) The people of #myname[Israel] did what was evil in the sight of the #myhl(divine)[#smallcaps[Lord]], and the #myhl(divine)[#smallcaps[Lord]] gave them into the hand of #myname[Midian] #mynumber[seven] years. 
...
#versenum(6) And #myname[Israel] was brought very low because of #myname[Midian]. And the people of #myname[Israel] cried out for help to the #myhl(divine)[#smallcaps[Lord]].


  
#versenum(7) When the people of #myname[Israel] cried out to the #myhl(divine)[#smallcaps[Lord]] on account of the #myname[Midianites], 
#versenum(8) the #myhl(divine)[#smallcaps[Lord]] sent a #underline[prophet] to the people of #myname[Israel]. And he said to them, “Thus says the #myhl(divine)[#smallcaps[Lord], the God of Israel]: I led you up from #myhl(places)[Egypt] and brought you out of the house of slavery. 
...
#versenum(10) And I said to you, ‘I am the #myhl(divine)[#smallcaps[Lord] your God]; you shall not fear the gods of the #myname[Amorites] in whose land you dwell.’ But you have not obeyed my voice.”
...
#versenum(11) Now the #myhl(divine)[angel of the #smallcaps[Lord]] came and sat under the terebinth at #myhl(places)[Ophrah], which belonged to #myhl(men)[Joash] the #underline[#myname[Abiezrite]], while his son #myhl(men)[Gideon] was beating out wheat in the winepress to hide it from the #myname[Midianites]. 
...
#versenum(13) And #myhl(men)[Gideon] said to him, “Please, my lord, if the #myhl(divine)[#smallcaps[Lord]] is with us, why then has all this happened to us? And where are all his wonderful deeds that our fathers #underline[recounted] to us, saying, ‘Did not the #myhl(divine)[#smallcaps[Lord]] bring us up from #myhl(places)[Egypt]?’ But now the #myhl(divine)[#smallcaps[Lord]] has forsaken us and given us into the hand of #myname[Midian].” 
#versenum(14) And the #myhl(divine)[#smallcaps[Lord]]#footnote[Judges 6:14 Septuagint #emph[the angel of the Lord]; also verse 16] turned to him and said, “Go in this might of yours and save #myname[Israel] from the hand of #myname[Midian]; do not I send you?” 
#versenum(15) And he said to him, “Please, Lord, how can I save #myname[Israel]? Behold, my clan is the #underline[weakest] in #myhl(places)[Manasseh], and I am the #underline[least] in my father’s house.” 
#versenum(16) And the #myhl(divine)[#smallcaps[Lord]] said to him, “But I will be with you, and you shall strike the #myname[Midianites] as one man.” 
...
#versenum(24) Then #myhl(men)[Gideon] built an altar there to the #myhl(divine)[#smallcaps[Lord]] and called it, The #myhl(divine)[#smallcaps[Lord]] Is Peace. To this day it still stands at #myhl(places)[Ophrah], which belongs to the #myname[Abiezrites].


  
#versenum(25) That night the #myhl(divine)[#smallcaps[Lord]] said to him, “Take your father’s bull, and the #mynumber[second] bull #mynumber[seven] years old, and pull down the altar of #myname[Baal] that your father has, and cut down the #myname[Asherah] that is beside it 
#versenum(26) and build an altar to the #myhl(divine)[#smallcaps[Lord] your God] on the top of the stronghold here, with stones laid in #underline[due] order. Then take the #mynumber[second] bull and offer it as a burnt offering with the wood of the #myname[Asherah] that you shall cut down.” 
#versenum(27) So #myhl(men)[Gideon] took #mynumber[ten] men of his servants and did as the #myhl(divine)[#smallcaps[Lord]] had told him. But because he was too afraid of his family and the men of the town to do it by day, he did it by night.
...
#versenum(30) Then the men of the town said to #myhl(men)[Joash], “Bring out your son, that he may die, for he has broken down the altar of #myname[Baal] and cut down the #myname[Asherah] beside it.” 
#versenum(31) But #myhl(men)[Joash] said to all who stood against him, “Will you contend for #myname[Baal]? Or will you save him? Whoever #underline[contends] for him shall be put to death by morning. If he is a god, let him contend for himself, because his altar has been broken down.” 
#versenum(32) Therefore on that day #myhl(men)[Gideon]#footnote[Judges 6:32 Hebrew #emph[he]] was called #myhl(men)[Jerubbaal], that is to say, “Let #myname[Baal] contend against him,” because he broke down his altar.


  
#versenum(33) Now all the #myname[Midianites] and the #myname[Amalekites] and the people of the East came together, and they crossed the #myhl(places)[Jordan] and encamped in the #myhl(places)[Valley of Jezreel]. 
#versenum(34) But the #myhl(divine)[Spirit] of the #myhl(divine)[#smallcaps[Lord]] #underline[clothed] #myhl(men)[Gideon], and he sounded the trumpet, and the #myname[Abiezrites] were called out to follow him. 
...
#versenum(36) Then #myhl(men)[Gideon] said to #myhl(divine)[God], “If you will save #myname[Israel] by my hand, as you have said, 
...
#versenum(2) The #myhl(divine)[#smallcaps[Lord]] said to #myhl(men)[Gideon], “The people with you are too many for me to give the #myname[Midianites] into their hand, lest #myname[Israel] #underline[boast] over me, saying, ‘My own hand has saved me.’ 
#versenum(3) Now therefore #underline[proclaim] in the ears of the people, saying, ‘Whoever is #underline[fearful] and #underline[trembling], let him return home and hurry away from #myhl(places)[Mount Gilead].’” Then #mynumber[22,000] of the people returned, and #mynumber[10,000] remained.
...
#versenum(7) And the #myhl(divine)[#smallcaps[Lord]] said to #myhl(men)[Gideon], “With the #mynumber[300] men who lapped I will save you and give the #myname[Midianites] into your hand, and let all the others go every man to his home.” 
#versenum(8) So the people took provisions in their hands, and their trumpets. And he sent all the rest of #myname[Israel] every man to his tent, but #underline[retained] the #mynumber[300] men. And #myhl(places)[the camp of Midian] was below him in the valley.
...
#versenum(14) And his comrade answered, “This is no other than the sword of #myhl(men)[Gideon] the son of #myhl(men)[Joash], a man of #myname[Israel]; #myhl(divine)[God] has given into his hand #myname[Midian] and all the camp.”


  
#versenum(15) As soon as #myhl(men)[Gideon] heard the telling of the dream and its #underline[interpretation], he worshiped. And he returned to #myhl(places)[the camp of Israel] and said, “Arise, for the #myhl(divine)[#smallcaps[Lord]] has given the #underline[host] of #myname[Midian] into your hand.” 
...
#versenum(19) So #myhl(men)[Gideon] and the #mynumber[hundred] men who were with him came to the outskirts of the camp at the beginning of the middle watch, when they had just set the watch. And they blew the trumpets and #underline[smashed] the jars that were in their hands. 
#versenum(20) Then the #mynumber[three] companies blew the trumpets and broke the jars. They held in their left hands the torches, and in their right hands the trumpets to blow. And they cried out, “A sword for the #myhl(divine)[#smallcaps[Lord]] and for #myhl(men)[Gideon]!” 
#versenum(21) Every man stood in his place around the camp, and all the army ran. They cried out and fled. 
#versenum(22) When they blew the #mynumber[300] trumpets, the #myhl(divine)[#smallcaps[Lord]] set every man’s sword against his comrade and against all the army. And the army fled as far as #underline[#myhl(places)[Beth-shittah]] toward #underline[#myhl(places)[Zererah]],#footnote[Judges 7:22 Some Hebrew manuscripts #emph[Zeredah]] as far as the border of #underline[#myhl(places)[Abel-meholah]], by #underline[#myhl(places)[Tabbath]]. 
...
#versenum(24) #myhl(men)[Gideon] sent messengers throughout all #myhl(places)[the hill country of Ephraim], saying, “Come down against the #myname[Midianites] and #underline[capture] the waters against them, as far as #myhl(places)[Beth-barah], and also the #myhl(places)[Jordan].” So all the men of #myname[Ephraim] were called out, and they captured the waters as far as #myhl(places)[Beth-barah], and also the #myhl(places)[Jordan]. 
#versenum(25) And they captured the #mynumber[two] princes of #myname[Midian], #myhl(men)[Oreb] and #myhl(men)[Zeeb]. They killed #myhl(men)[Oreb] at the #myhl(places)[rock of Oreb], and #myhl(men)[Zeeb] they killed at the #myhl(places)[winepress of Zeeb]. Then they pursued #myname[Midian], and they brought the heads of #myhl(men)[Oreb] and #myhl(men)[Zeeb] to #myhl(men)[Gideon] #underline[across] the #myhl(places)[Jordan].
...
#versenum(2) And he said to them, “What have I done now in comparison with you? Is not the gleaning of the grapes of #myname[Ephraim] better than the #underline[grape] harvest of #myhl(men)[Abiezer]? 
#versenum(3) #myhl(divine)[God] has given into your hands the princes of #myname[Midian], #myhl(men)[Oreb] and #myhl(men)[Zeeb]. What have I been able to do in comparison with you?” Then their anger#footnote[Judges 8:3 Hebrew #emph[their spirit]] against him #underline[subsided] when he said this.


  
#versenum(4) And #myhl(men)[Gideon] came to the #myhl(places)[Jordan] and crossed over, he and the #mynumber[300] men who were with him, exhausted yet pursuing. 
#versenum(5) So he said to the men of #myhl(places)[Succoth], “Please give #underline[loaves] of bread to the people who follow me, for they are exhausted, and I am pursuing after #myhl(men)[Zebah] and #myhl(men)[Zalmunna], the kings of #myname[Midian].” 
...
#versenum(10) Now #myhl(men)[Zebah] and #myhl(men)[Zalmunna] were in #underline[#myhl(places)[Karkor]] with their army, about #underline[#mynumber[15,000]] men, all who were left of all the army of the people of the East, for there had fallen #underline[#mynumber[120,000]] men who drew the sword. 
...
#versenum(12) And #myhl(men)[Zebah] and #myhl(men)[Zalmunna] fled, and he pursued them and captured the #mynumber[two] kings of #myname[Midian], #myhl(men)[Zebah] and #myhl(men)[Zalmunna], and he threw all the army into a panic.


  
#versenum(13) Then #myhl(men)[Gideon] the son of #myhl(men)[Joash] returned from the battle by the ascent of #myhl(places)[Heres]. 
#versenum(14) And he captured a young man of #myhl(places)[Succoth] and #underline[questioned] him. And he wrote down for him the officials and elders of #myhl(places)[Succoth], #underline[#mynumber[seventy-seven]] men. 
...
#versenum(22) Then the men of #myname[Israel] said to #myhl(men)[Gideon], “Rule over us, you and your son and your #underline[grandson] also, for you have saved us from the hand of #myname[Midian].” 
...
#versenum(24) And #myhl(men)[Gideon] said to them, “Let me make a #underline[request] of you: every one of you give me the earrings from his spoil.” (For they had golden earrings, because they were #underline[#myname[Ishmaelites]].) 
...
#versenum(27) And #myhl(men)[Gideon] made an ephod of it and put it in his city, in #myhl(places)[Ophrah]. And all #myname[Israel] whored after it there, and it became a snare to #myhl(men)[Gideon] and to his family. 
#versenum(28) So #myname[Midian] was subdued before the people of #myname[Israel], and they raised their heads no more. And the land had rest for #mynumber[forty] years in the days of #myhl(men)[Gideon].
...
#versenum(30) Now #myhl(men)[Gideon] had #mynumber[seventy] sons, his own offspring,#footnote[Judges 8:30 Hebrew #emph[who came from his own loins]] for he had many wives. 
...
#versenum(32) And #myhl(men)[Gideon] the son of #myhl(men)[Joash] died in a good old age and was buried in the tomb of #myhl(men)[Joash] his father, at #myhl(places)[Ophrah] of the #myname[Abiezrites].


  
#versenum(33) As soon as #myhl(men)[Gideon] died, the people of #myname[Israel] turned again and whored after the #myname[Baals] and made #myname[Baal-berith] their god. 
#versenum(34) And the people of #myname[Israel] did not remember the #myhl(divine)[#smallcaps[Lord]] their #myhl(divine)[God], who had delivered them from the hand of all their enemies on every side, 
#versenum(35) and they did not show #underline[steadfast] love to the family of #myhl(men)[Jerubbaal] (that is, #myhl(men)[Gideon]) in return for all the good that he had done to #myname[Israel].
...
#versenum(2) “Say in the ears of all the leaders of #myhl(places)[Shechem], ‘Which is better for you, that all #mynumber[seventy] of the sons of #myhl(men)[Jerubbaal] rule over you, or that one rule over you?’ Remember also that I am your #underline[bone] and your flesh.”
...
#versenum(4) And they gave him #mynumber[seventy] pieces of silver out of the house of #myname[Baal-berith] with which #myhl(men)[Abimelech] hired worthless and #underline[reckless] fellows, who followed him. 
#versenum(5) And he went to his father’s house at #myhl(places)[Ophrah] and killed his brothers the sons of #myhl(men)[Jerubbaal], #mynumber[seventy] men, on one stone. But #myhl(men)[Jotham] the youngest son of #myhl(men)[Jerubbaal] was left, for he hid himself. 
...
#versenum(18) and you have #underline[risen] up against my father’s house this day and have killed his sons, #mynumber[seventy] men on one stone, and have made #myhl(men)[Abimelech], the son of his female servant, king over the leaders of #myhl(places)[Shechem], because he is your relative—
...
#versenum(22) #myhl(men)[Abimelech] ruled over #myname[Israel] #mynumber[three] years. 
...
#versenum(24) that the #underline[violence] done to the #mynumber[seventy] sons of #myhl(men)[Jerubbaal] might come, and their blood be laid on #myhl(men)[Abimelech] their brother, who killed them, and on the men of #myhl(places)[Shechem], who strengthened his hands to kill his brothers. 
...
#versenum(34) So #myhl(men)[Abimelech] and all the men who were with him rose up by night and set an ambush against #myhl(places)[Shechem] in #mynumber[four] companies. 
...
#versenum(44) #myhl(men)[Abimelech] and the company that was with him rushed forward and stood at the entrance of the gate of the city, while the #mynumber[two] companies rushed upon all who were in the field and killed them. 
...
#versenum(46) When all the leaders of the Tower of #myhl(places)[Shechem] heard of it, they entered the stronghold of the house of #underline[#myname[El-berith]]. 
...
#versenum(49) So every one of the people cut down his bundle and following #myhl(men)[Abimelech] put it against the stronghold, and they set the stronghold on fire over them, so that all the people of the Tower of #myhl(places)[Shechem] also died, about #mynumber[1,000] men and women.
...
#versenum(55) And when the men of #myname[Israel] saw that #myhl(men)[Abimelech] was dead, everyone departed to his home. 
#versenum(56) Thus #myhl(divine)[God] returned the evil of #myhl(men)[Abimelech], which he committed against his father in killing his #mynumber[seventy] brothers. 
...
#versenum(1) After #myhl(men)[Abimelech] there arose to save #myname[Israel] #underline[#myhl(men)[Tola]] the son of #underline[#myhl(men)[Puah]], son of #underline[#myhl(men)[Dodo]], a man of #myname[Issachar], and he lived at #myhl(places)[Shamir] in #myhl(places)[the hill country of Ephraim]. 
#versenum(2) And he judged #myname[Israel] #underline[#mynumber[twenty-three]] years. Then he died and was buried at #myhl(places)[Shamir].


  
#versenum(3) After him arose #myhl(men)[Jair] the #myname[Gileadite], who judged #myname[Israel] #mynumber[twenty-two] years. 
#versenum(4) And he had #mynumber[thirty] sons who rode on #mynumber[thirty] donkeys, and they had #mynumber[thirty] cities, called #underline[#myhl(places)[Havvoth-jair]] to this day, which are in the land of #myhl(places)[Gilead]. 
...
#versenum(6) The people of #myname[Israel] again did what was evil in the sight of the #myhl(divine)[#smallcaps[Lord]] and served the #myname[Baals] and the #myname[Ashtaroth], the gods of #underline[#myhl(places)[Syria]], the gods of #myhl(places)[Sidon], the gods of #myhl(places)[Moab], the gods of the #myname[Ammonites], and the gods of the #myname[Philistines]. And they #underline[forsook] the #myhl(divine)[#smallcaps[Lord]] and did not serve him. 
#versenum(7) So the anger of the #myhl(divine)[#smallcaps[Lord]] was kindled against #myname[Israel], and he sold them into the hand of the #myname[Philistines] and into the hand of the #myname[Ammonites], 
#versenum(8) and they crushed and oppressed the people of #myname[Israel] that year. For #mynumber[eighteen] years they oppressed all the people of #myname[Israel] who were beyond the #myhl(places)[Jordan] in the land of the #myname[Amorites], which is in #myhl(places)[Gilead]. 
#versenum(9) And the #myname[Ammonites] crossed the #myhl(places)[Jordan] to fight also against #myname[Judah] and against #myname[Benjamin] and against the house of #myname[Ephraim], so that #myname[Israel] was #underline[severely] #underline[distressed].


  
#versenum(10) And the people of #myname[Israel] cried out to the #myhl(divine)[#smallcaps[Lord]], saying, “We have sinned against you, because we have forsaken our #myhl(divine)[God] and have served the #myname[Baals].” 
#versenum(11) And the #myhl(divine)[#smallcaps[Lord]] said to the people of #myname[Israel], “Did I not save you from the #myname[Egyptians] and from the #myname[Amorites], from the #myname[Ammonites] and from the #myname[Philistines]? 
...
#versenum(15) And the people of #myname[Israel] said to the #myhl(divine)[#smallcaps[Lord]], “We have sinned; do to us whatever seems good to you. Only please deliver us this day.” 
#versenum(16) So they put away the foreign gods from among them and served the #myhl(divine)[#smallcaps[Lord]], and he became #underline[impatient] over the #underline[misery] of #myname[Israel].


  
#versenum(17) Then the #myname[Ammonites] were called to arms, and they encamped in #myhl(places)[Gilead]. And the people of #myname[Israel] came together, and they encamped at #myhl(places)[Mizpah]. 
#versenum(18) And the people, the leaders of #myhl(places)[Gilead], said one to another, “Who is the man who will begin to fight against the #myname[Ammonites]? He shall be head over all the inhabitants of #myhl(places)[Gilead].”
...
#versenum(1) Now #myhl(men)[Jephthah] the #myname[Gileadite] was a mighty #underline[warrior], but he was the son of a prostitute. #myhl(places)[Gilead] was the father of #myhl(men)[Jephthah]. 
...
#versenum(3) Then #myhl(men)[Jephthah] fled from his brothers and lived in the land of #myname[Tob], and worthless fellows #underline[collected] around #myhl(men)[Jephthah] and went out with him.


  
#versenum(4) After a time the #myname[Ammonites] made war against #myname[Israel]. 
#versenum(5) And when the #myname[Ammonites] made war against #myname[Israel], the elders of #myhl(places)[Gilead] went to bring #myhl(men)[Jephthah] from the land of #myname[Tob]. 
#versenum(6) And they said to #myhl(men)[Jephthah], “Come and be our leader, that we may fight against the #myname[Ammonites].” 
...
#versenum(8) And the elders of #myhl(places)[Gilead] said to #myhl(men)[Jephthah], “That is why we have turned to you now, that you may go with us and fight against the #myname[Ammonites] and be our head over all the inhabitants of #myhl(places)[Gilead].” 
#versenum(9) #myhl(men)[Jephthah] said to the elders of #myhl(places)[Gilead], “If you bring me home again to fight against the #myname[Ammonites], and the #myhl(divine)[#smallcaps[Lord]] gives them over to me, I will be your head.” 
...
#versenum(12) Then #myhl(men)[Jephthah] sent messengers to the king of the #myname[Ammonites] and said, “What do you have against me, that you have come to me to fight against my land?” 
#versenum(13) And the king of the #myname[Ammonites] answered the messengers of #myhl(men)[Jephthah], “Because #myname[Israel] on coming up from #myhl(places)[Egypt] took away my land, from the #myhl(places)[Arnon] to the #myhl(places)[Jabbok] and to the #myhl(places)[Jordan]; now therefore restore it #underline[peaceably].” 
#versenum(14) #myhl(men)[Jephthah] again sent messengers to the king of the #myname[Ammonites] 
#versenum(15) and said to him, “Thus says #myhl(men)[Jephthah]: #myname[Israel] did not take away the land of #myhl(places)[Moab] or the land of the #myname[Ammonites], 
#versenum(16) but when they came up from #myhl(places)[Egypt], #myname[Israel] went through the wilderness to the #myhl(places)[Red Sea] and came to #myhl(places)[Kadesh]. 
#versenum(17) #myname[Israel] then sent messengers to the king of #myhl(places)[Edom], saying, ‘Please let us pass through your land,’ but the king of #myhl(places)[Edom] would not listen. And they sent also to the king of #myhl(places)[Moab], but he would not #underline[consent]. So #myname[Israel] remained at #myhl(places)[Kadesh].
...
#versenum(19) #myname[Israel] then sent messengers to #myhl(men)[Sihon] king of the #myname[Amorites], king of #myhl(places)[Heshbon], and #myname[Israel] said to him, ‘Please let us pass through your land to our country,’ 
#versenum(20) but #myhl(men)[Sihon] did not #underline[trust] #myname[Israel] to pass through his territory, so #myhl(men)[Sihon] gathered all his people together and encamped at #myhl(places)[Jahaz] and fought with #myname[Israel]. 
#versenum(21) And the #myhl(divine)[#smallcaps[Lord], the God of Israel], gave #myhl(men)[Sihon] and all his people into the hand of #myname[Israel], and they defeated them. So #myname[Israel] took possession of all the land of the #myname[Amorites], who inhabited that country. 
#versenum(22) And they took possession of all the territory of the #myname[Amorites] from the #myhl(places)[Arnon] to the #myhl(places)[Jabbok] and from the wilderness to the #myhl(places)[Jordan]. 
#versenum(23) So then the #myhl(divine)[#smallcaps[Lord], the God of Israel], dispossessed the #myname[Amorites] from before his people #myname[Israel]; and are you to take possession of them? 
#versenum(24) Will you not possess what #underline[#myname[Chemosh]] your god gives you to possess? And all that the #myhl(divine)[#smallcaps[Lord]] our #myhl(divine)[God] has dispossessed before us, we will possess. 
#versenum(25) Now are you any better than #myhl(men)[Balak] the son of #myhl(men)[Zippor], king of #myhl(places)[Moab]? Did he ever contend against #myname[Israel], or did he ever go to war with them? 
#versenum(26) While #myname[Israel] lived in #myhl(places)[Heshbon] and its villages, and in #myhl(places)[Aroer] and its villages, and in all the cities that are on the banks of the #myhl(places)[Arnon], #mynumber[300] years, why did you not deliver them within that time? 
#versenum(27) I therefore have not sinned against you, and you do me #underline[wrong] by making war on me. The #myhl(divine)[#smallcaps[Lord]], the Judge, #underline[decide] this day between the people of #myname[Israel] and the people of #underline[#myname[Ammon]].” 
#versenum(28) But the king of the #myname[Ammonites] did not listen to the words of #myhl(men)[Jephthah] that he sent to him.
...
#versenum(29) Then the #myhl(divine)[Spirit] of the #myhl(divine)[#smallcaps[Lord]] was upon #myhl(men)[Jephthah], and he passed through #myhl(places)[Gilead] and #myhl(places)[Manasseh] and passed on to #myhl(places)[Mizpah] of #myhl(places)[Gilead], and from #myhl(places)[Mizpah] of #myhl(places)[Gilead] he passed on to the #myname[Ammonites]. 
#versenum(30) And #myhl(men)[Jephthah] made a vow to the #myhl(divine)[#smallcaps[Lord]] and said, “If you will give the #myname[Ammonites] into my hand, 
#versenum(31) then whatever#footnote[Judges 11:31 Or #emph[whoever]] comes out from the doors of my house to meet me when I return in peace from the #myname[Ammonites] shall be the #myhl(divine)[#smallcaps[Lord]]’s, and I will offer it#footnote[Judges 11:31 Or #emph[him]] up for a burnt offering.” 
#versenum(32) So #myhl(men)[Jephthah] crossed over to the #myname[Ammonites] to fight against them, and the #myhl(divine)[#smallcaps[Lord]] gave them into his hand. 
#versenum(33) And he struck them from #myhl(places)[Aroer] to the neighborhood of #underline[#myhl(places)[Minnith]], #mynumber[twenty] cities, and as far as #underline[#myhl(places)[Abel-keramim]], with a great blow. So the #myname[Ammonites] were subdued before the people of #myname[Israel].
...
#versenum(36) And she said to him, “My father, you have opened your mouth to the #myhl(divine)[#smallcaps[Lord]]; do to me according to what has gone out of your mouth, now that the #myhl(divine)[#smallcaps[Lord]] has avenged you on your enemies, on the #myname[Ammonites].” 
...
#versenum(39) And at the end of #mynumber[two] months, she returned to her father, who did with her according to his vow that he had made. She had never known a man, and it became a custom in #myhl(places)[Israel] 
#versenum(40) that the daughters of #myname[Israel] went year by year to #underline[lament] the daughter of #myhl(men)[Jephthah] the #myname[Gileadite] #mynumber[four] days in the year.
...
#versenum(1) The men of #myname[Ephraim] were called to arms, and they crossed to #myhl(places)[Zaphon] and said to #myhl(men)[Jephthah], “Why did you #underline[cross] over to fight against the #myname[Ammonites] and did not call us to go with you? We will burn your house over you with fire.” 
#versenum(2) And #myhl(men)[Jephthah] said to them, “I and my people had a great #underline[dispute] with the #myname[Ammonites], and when I called you, you did not save me from their hand. 
#versenum(3) And when I saw that you would not save me, I took my life in my hand and crossed over against the #myname[Ammonites], and the #myhl(divine)[#smallcaps[Lord]] gave them into my hand. Why then have you come up to me this day to fight against me?” 
#versenum(4) Then #myhl(men)[Jephthah] gathered all the men of #myhl(places)[Gilead] and fought with #myname[Ephraim]. And the men of #myhl(places)[Gilead] struck #myname[Ephraim], because they said, “You are fugitives of #myname[Ephraim], you #myname[Gileadites], in the midst of #myname[Ephraim] and #myname[Manasseh].” 
#versenum(5) And the #myname[Gileadites] captured the fords of the #myhl(places)[Jordan] against the #myname[Ephraimites]. And when any of the fugitives of #myname[Ephraim] said, “Let me go over,” the men of #myhl(places)[Gilead] said to him, “Are you an #underline[#myname[Ephraimite]]?” When he said, “No,” 
#versenum(6) they said to him, “Then say #underline[Shibboleth],” and he said, “#underline[Sibboleth],” for he could not #underline[pronounce] it right. Then they seized him and #underline[slaughtered] him at the fords of the #myhl(places)[Jordan]. At that time #underline[#mynumber[42,000]] of the #myname[Ephraimites] fell.


  
#versenum(7) #myhl(men)[Jephthah] judged #myname[Israel] #mynumber[six] years. Then #myhl(men)[Jephthah] the #myname[Gileadite] died and was buried in his city in #myhl(places)[Gilead].#footnote[Judges 12:7 Septuagint; Hebrew #emph[in the cities of Gilead]]
...
#versenum(8) After him #myhl(men)[Ibzan] of #myhl(places)[Bethlehem] judged #myname[Israel]. 
...
#versenum(11) After him #myhl(men)[Elon] the #myname[Zebulunite] judged #myname[Israel], and he judged #myname[Israel] #mynumber[ten] years. 
#versenum(12) Then #myhl(men)[Elon] the #myname[Zebulunite] died and was buried at #myhl(places)[Aijalon] in the land of #myname[Zebulun].


  
#versenum(13) After him #myhl(men)[Abdon] the son of #myhl(men)[Hillel] the #myname[Pirathonite] judged #myname[Israel]. 
...
#versenum(15) Then #myhl(men)[Abdon] the son of #myhl(men)[Hillel] the #myname[Pirathonite] died and was buried at #underline[#myhl(places)[Pirathon]] in the land of #myname[Ephraim], in the hill country of the #myname[Amalekites].
...
#versenum(1) And the people of #myname[Israel] again did what was evil in the sight of the #myhl(divine)[#smallcaps[Lord]], so the #myhl(divine)[#smallcaps[Lord]] gave them into the hand of the #myname[Philistines] for #mynumber[forty] years.


  
#versenum(2) There was a certain man of #myhl(places)[Zorah], of the tribe of the #myname[Danites], whose name was #myhl(men)[Manoah]. And his wife was barren and had no children. 
...
#versenum(5) for behold, you shall conceive and bear a son. No razor shall come upon his head, for the child shall be a #myname[Nazirite] to #myhl(divine)[God] from the womb, and he shall begin to save #myname[Israel] from the hand of the #myname[Philistines].” 
...
#versenum(7) but he said to me, ‘Behold, you shall conceive and bear a son. So then drink no wine or strong drink, and eat nothing unclean, for the child shall be a #myname[Nazirite] to #myhl(divine)[God] from the womb to the day of his death.’”
...
#versenum(1) #myhl(men)[Samson] went down to #myhl(places)[Timnah], and at #myhl(places)[Timnah] he saw one of the daughters of the #myname[Philistines]. 
#versenum(2) Then he came up and told his father and mother, “I saw one of the daughters of the #myname[Philistines] at #myhl(places)[Timnah]. Now get her for me as my wife.” 
#versenum(3) But his father and mother said to him, “Is there not a woman among the daughters of your relatives, or among all our people, that you must go to take a wife from the uncircumcised #myname[Philistines]?” But #myhl(men)[Samson] said to his father, “Get her for me, for she is right in my eyes.”


  
#versenum(4) His father and mother did not know that it was from the #myhl(divine)[#smallcaps[Lord]], for he was seeking an #underline[opportunity] against the #myname[Philistines]. At that time the #myname[Philistines] ruled over #myname[Israel].
...
#versenum(12) And #myhl(men)[Samson] said to them, “Let me now put a riddle to you. If you can tell me what it is, within the #mynumber[seven] days of the feast, and find it out, then I will give you #mynumber[thirty] linen garments and #mynumber[thirty] changes of clothes, 
...
#versenum(15) On the #mynumber[fourth]#footnote[Judges 14:15 Septuagint, Syriac; Hebrew #emph[seventh]] day they said to #myhl(men)[Samson]’s wife, “#underline[Entice] your husband to tell us what the riddle is, lest we burn you and your father’s house with fire. Have you invited us here to #underline[impoverish] us?” 
...
#versenum(3) And #myhl(men)[Samson] said to them, “This time I shall be #underline[innocent] in regard to the #myname[Philistines], when I do them harm.” 
#versenum(4) So #myhl(men)[Samson] went and caught #mynumber[300] foxes and took torches. And he turned them tail to tail and put a #underline[torch] between each #underline[pair] of #underline[tails]. 
...
#versenum(6) Then the #myname[Philistines] said, “Who has done this?” And they said, “#myhl(men)[Samson], the son-in-law of the #underline[#myname[Timnite]], because he has taken his wife and given her to his companion.” And the #myname[Philistines] came up and burned her and her father with fire. 
...
#versenum(9) Then the #myname[Philistines] came up and encamped in #myhl(places)[Judah] and made a #underline[raid] on #myhl(places)[Lehi]. 
#versenum(10) And the men of #myname[Judah] said, “Why have you come up against us?” They said, “We have come up to bind #myhl(men)[Samson], to do to him as he did to us.” 
#versenum(11) Then #mynumber[3,000] men of #myname[Judah] went down to the cleft of the #myhl(places)[rock of Etam], and said to #myhl(men)[Samson], “Do you not know that the #myname[Philistines] are rulers over us? What then is this that you have done to us?” And he said to them, “As they did to me, so have I done to them.” 
#versenum(12) And they said to him, “We have come down to bind you, that we may give you into the hands of the #myname[Philistines].” And #myhl(men)[Samson] said to them, “Swear to me that you will not attack me yourselves.” 
...
#versenum(14) When he came to #myhl(places)[Lehi], the #myname[Philistines] came #underline[shouting] to meet him. Then the #myhl(divine)[Spirit] of the #myhl(divine)[#smallcaps[Lord]] rushed upon him, and the ropes that were on his arms became as flax that has caught fire, and his #underline[bonds] melted off his hands. 
...
#versenum(2) The #underline[#myname[Gazites]] were told, “#myhl(men)[Samson] has come here.” And they surrounded the place and set an ambush for him all night at the gate of the city. They kept quiet all night, saying, “Let us wait till the light of the morning; then we will kill him.” 
#versenum(3) But #myhl(men)[Samson] lay till midnight, and at midnight he arose and took hold of the doors of the gate of the city and the #mynumber[two] #underline[posts], and pulled them up, bar and all, and put them on his #underline[shoulders] and carried them to the top of the hill that is in front of #myhl(places)[Hebron].
...
#versenum(7) #myhl(men)[Samson] said to her, “If they bind me with #mynumber[seven] fresh bowstrings that have not been dried, then I shall become weak and be like any other man.” 
...
#versenum(9) Now she had men lying in ambush in an inner chamber. And she said to him, “The #myname[Philistines] are upon you, #myhl(men)[Samson]!” But he snapped the bowstrings, as a thread of flax #underline[snaps] when it touches the fire. So the secret of his strength was not known.
...
#versenum(12) So #myhl(women)[Delilah] took new ropes and bound him with them and said to him, “The #myname[Philistines] are upon you, #myhl(men)[Samson]!” And the men lying in ambush were in an inner chamber. But he snapped the ropes off his arms like a thread.
...
#versenum(14) So while he #underline[slept], #myhl(women)[Delilah] took the #mynumber[seven] locks of his head and #underline[wove] them into the web.#footnote[Judges 16:14 Compare Septuagint; Hebrew lacks #emph[and fasten it tight . . . into the web]] And she made them tight with the pin and said to him, “The #myname[Philistines] are upon you, #myhl(men)[Samson]!” But he awoke from his sleep and pulled away the pin, the #underline[loom], and the web.
...
#versenum(17) And he told her all his heart, and said to her, “A razor has never come upon my head, for I have been a #myname[Nazirite] to #myhl(divine)[God] from my mother’s womb. If my head is shaved, then my strength will leave me, and I shall become weak and be like any other man.”


  
#versenum(18) When #myhl(women)[Delilah] saw that he had told her all his heart, she sent and called the lords of the #myname[Philistines], saying, “Come up again, for he has told me all his heart.” Then the lords of the #myname[Philistines] came up to her and brought the money in their hands. 
...
#versenum(20) And she said, “The #myname[Philistines] are upon you, #myhl(men)[Samson]!” And he awoke from his sleep and said, “I will go out as at other times and #underline[shake] myself #underline[free].” But he did not know that the #myhl(divine)[#smallcaps[Lord]] had left him. 
#versenum(21) And the #myname[Philistines] seized him and #underline[gouged] out his eyes and brought him down to #myhl(places)[Gaza] and bound him with bronze #underline[shackles]. And he ground at the #underline[mill] in the prison. 
...
#versenum(23) Now the lords of the #myname[Philistines] gathered to offer a great sacrifice to #underline[#myname[Dagon]] their god and to rejoice, and they said, “Our god has given #myhl(men)[Samson] our enemy into our hand.” 
...
#versenum(27) Now the house was full of men and women. All the lords of the #myname[Philistines] were there, and on the roof there were about #mynumber[3,000] men and women, who looked on while #myhl(men)[Samson] entertained.


  
#versenum(28) Then #myhl(men)[Samson] called to the #myhl(divine)[#smallcaps[Lord]] and said, “O #myhl(divine)[Lord] #myhl(divine)[GOD], please remember me and please strengthen me only this once, O #myhl(divine)[God], that I may be avenged on the #myname[Philistines] for my #mynumber[two] eyes.” 
#versenum(29) And #myhl(men)[Samson] #underline[grasped] the #mynumber[two] middle pillars on which the house rested, and he #underline[leaned] his weight against them, his right hand on the one and his left hand on the other. 
#versenum(30) And #myhl(men)[Samson] said, “Let me die with the #myname[Philistines].” Then he bowed with all his strength, and the house fell upon the lords and upon all the people who were in it. So the dead whom he killed at his death were more than those whom he had killed #underline[during] his life. 
#versenum(31) Then his brothers and all his family came down and took him and brought him up and buried him between #myhl(places)[Zorah] and #myhl(places)[Eshtaol] in the tomb of #myhl(men)[Manoah] his father. He had judged #myname[Israel] #mynumber[twenty] years.
...
#versenum(2) And he said to his mother, “The #mynumber[1,100] pieces of silver that were taken from you, about which you #underline[uttered] a curse, and also spoke it in my ears, behold, the silver is with me; I took it.” And his mother said, “Blessed be my son by the #myhl(divine)[#smallcaps[Lord]].” 
#versenum(3) And he restored the #mynumber[1,100] pieces of silver to his mother. And his mother said, “I #underline[dedicate] the silver to the #myhl(divine)[#smallcaps[Lord]] from my hand for my son, to make a carved image and a metal image. Now therefore I will restore it to you.” 
#versenum(4) So when he restored the money to his mother, his mother took #mynumber[200] pieces of silver and gave it to the #underline[silversmith], who made it into a carved image and a metal image. And it was in the house of #myhl(men)[Micah]. 
...
#versenum(7) Now there was a young man of #myhl(places)[Bethlehem in Judah], of the family of #myname[Judah], who was a #myname[Levite], and he #underline[sojourned] there. 
...
#versenum(9) And #myhl(men)[Micah] said to him, “Where do you come from?” And he said to him, “I am a #myname[Levite] of #myhl(places)[Bethlehem in Judah], and I am going to sojourn where I may find a place.” 
#versenum(10) And #myhl(men)[Micah] said to him, “Stay with me, and be to me a father and a priest, and I will give you #mynumber[ten] pieces of silver a year and a #underline[suit] of clothes and your living.” And the #myname[Levite] went in. 
#versenum(11) And the #myname[Levite] was content to dwell with the man, and the young man became to him like one of his sons. 
#versenum(12) And #myhl(men)[Micah] ordained the #myname[Levite], and the young man became his priest, and was in the house of #myhl(men)[Micah]. 
#versenum(13) Then #myhl(men)[Micah] said, “Now I know that the #myhl(divine)[#smallcaps[Lord]] will #underline[prosper] me, because I have a #myname[Levite] as priest.”
...
#versenum(1) In those days there was no king in #myhl(places)[Israel]. And in those days the tribe of the people of #myname[Dan] was seeking for itself an inheritance to dwell in, for until then no inheritance among the tribes of #myname[Israel] had fallen to them. 
#versenum(2) So the people of #myname[Dan] sent #mynumber[five] able men from the whole number of their tribe, from #myhl(places)[Zorah] and from #myhl(places)[Eshtaol], to spy out the land and to explore it. And they said to them, “Go and explore the land.” And they came to #myhl(places)[the hill country of Ephraim], to the house of #myhl(men)[Micah], and lodged there. 
#versenum(3) When they were by the house of #myhl(men)[Micah], they #underline[recognized] the voice of the young #myname[Levite]. And they turned aside and said to him, “Who brought you here? What are you doing in this place? What is your business here?” 
...
#versenum(11) So #mynumber[600] men of the tribe of #myname[Dan], armed with weapons of war, set out from #myhl(places)[Zorah] and #myhl(places)[Eshtaol], 
...
#versenum(14) Then the #mynumber[five] men who had gone to scout out the country of #myhl(places)[Laish] said to their brothers, “Do you know that in these houses there are an ephod, household gods, a carved image, and a metal image? Now therefore consider what you will do.” 
#versenum(15) And they turned aside there and came to the house of the young #myname[Levite], at the home of #myhl(men)[Micah], and asked him about his #underline[welfare]. 
...
#versenum(22) When they had gone a distance from the home of #myhl(men)[Micah], the men who were in the houses near #myhl(men)[Micah]’s house were called out, and they overtook the people of #myname[Dan]. 
#versenum(23) And they shouted to the people of #myname[Dan], who turned around and said to #myhl(men)[Micah], “What is the matter with you, that you come with such a company?” 
...
#versenum(26) Then the people of #myname[Dan] went their way. And when #myhl(men)[Micah] saw that they were too strong for him, he turned and went back to his home.


  
#versenum(27) But the people of #myname[Dan] took what #myhl(men)[Micah] had made, and the priest who belonged to him, and they came to #myhl(places)[Laish], to a people quiet and unsuspecting, and struck them with the edge of the sword and burned the city with fire. 
...
#versenum(29) And they named the city #myname[Dan], after the name of #myname[Dan] their ancestor, who was born to #myname[Israel]; but the name of the city was #myhl(places)[Laish] at the first. 
#versenum(30) And the people of #myname[Dan] set up the carved image for themselves, and #underline[#myhl(men)[Jonathan]] the son of #underline[#myhl(men)[Gershom]], son of #myhl(men)[Moses],#footnote[Judges 18:30 Or #emph[Manasseh]] and his sons were priests to the tribe of the #myname[Danites] until the day of the #underline[captivity] of the land. 
...
#versenum(1) In those days, when there was no king in #myhl(places)[Israel], a certain #myname[Levite] was sojourning in the remote parts of #myhl(places)[the hill country of Ephraim], who took to himself a concubine from #myhl(places)[Bethlehem in Judah]. 
#versenum(2) And his concubine was #underline[unfaithful] to#footnote[Judges 19:2 Septuagint, Old Latin #emph[became angry with]] him, and she went away from him to her father’s house at #myhl(places)[Bethlehem in Judah], and was there some #mynumber[four] months. 
...
#versenum(10) But the man would not spend the night. He rose up and departed and arrived opposite #myhl(places)[Jebus] (that is, #myhl(places)[Jerusalem]). He had with him #mynumber[a couple] of #underline[saddled] donkeys, and his concubine was with him. 
#versenum(11) When they were near #myhl(places)[Jebus], the day was #underline[nearly] over, and the servant said to his master, “Come now, let us turn aside to this city of the #myname[Jebusites] and spend the night in it.” 
#versenum(12) And his master said to him, “We will not turn aside into the city of #underline[foreigners], who do not belong to the people of #myname[Israel], but we will pass on to #myhl(places)[Gibeah].” 
...
#versenum(14) So they passed on and went their way. And the sun went down on them near #myhl(places)[Gibeah], which belongs to #myname[Benjamin], 
...
#versenum(16) And behold, an old man was coming from his work in the field at evening. The man was from #myhl(places)[the hill country of Ephraim], and he was sojourning in #myhl(places)[Gibeah]. The men of the place were #myname[Benjaminites]. 
...
#versenum(29) And when he entered his house, he took a #underline[knife], and taking hold of his concubine he divided her, limb by limb, into #mynumber[twelve] pieces, and sent her throughout all the territory of #myhl(places)[Israel]. 
#versenum(30) And all who saw it said, “Such a thing has never happened or been seen from the day that the people of #myname[Israel] came up out of the land of #myhl(places)[Egypt] until this day; consider it, take counsel, and speak.”
...
#versenum(1) Then all the people of #myname[Israel] came out, from #myhl(places)[Dan] to #myhl(places)[Beersheba], #underline[including] the land of #myhl(places)[Gilead], and the congregation assembled as one man to the #myhl(divine)[#smallcaps[Lord]] at #myhl(places)[Mizpah]. 
#versenum(2) And the chiefs of all the people, of all the tribes of #myname[Israel], presented themselves in the assembly of the people of #myhl(divine)[God], #mynumber[400,000] men on foot that drew the sword. 
#versenum(3) (Now the people of #myname[Benjamin] heard that the people of #myname[Israel] had gone up to #myhl(places)[Mizpah].) And the people of #myname[Israel] said, “Tell us, how did this evil #underline[happen]?” 
#versenum(4) And the #myname[Levite], the husband of the woman who was #underline[murdered], answered and said, “I came to #myhl(places)[Gibeah] that belongs to #myname[Benjamin], I and my concubine, to spend the night. 
...
#versenum(6) So I took hold of my concubine and cut her in pieces and sent her throughout all the country of the inheritance of #myname[Israel], for they have committed #underline[abomination] and outrage in #myhl(places)[Israel]. 
...
#versenum(10) and we will take #mynumber[ten] men of a #mynumber[hundred] throughout all the tribes of #myname[Israel], and a #mynumber[hundred] of a #mynumber[thousand], and a #mynumber[thousand of ten thousand], to bring provisions for the people, that when they come they may repay #myhl(places)[Gibeah] of #myname[Benjamin] for all the outrage that they have committed in #myhl(places)[Israel].” 
...
#versenum(13) Now therefore give up the men, the worthless fellows in #myhl(places)[Gibeah], that we may put them to death and #underline[purge] evil from #myname[Israel].” But the #myname[Benjaminites] would not listen to the voice of their brothers, the people of #myname[Israel]. 
#versenum(14) Then the people of #myname[Benjamin] came together out of the cities to #myhl(places)[Gibeah] to go out to battle against the people of #myname[Israel]. 
#versenum(15) And the people of #myname[Benjamin] mustered out of their cities on that day #underline[#mynumber[26,000]] men who drew the sword, besides the inhabitants of #myhl(places)[Gibeah], who mustered #mynumber[700] chosen men. 
...
#versenum(18) The people of #myname[Israel] arose and went up to #myhl(places)[Bethel] and inquired of #myhl(divine)[God], “Who shall go up #mynumber[first] for us to fight against the people of #myname[Benjamin]?” And the #myhl(divine)[#smallcaps[Lord]] said, “#myname[Judah] shall go up #mynumber[first].”


  
#versenum(19) Then the people of #myname[Israel] rose in the morning and encamped against #myhl(places)[Gibeah]. 
#versenum(20) And the men of #myname[Israel] went out to fight against #myname[Benjamin], and the men of #myname[Israel] drew up the battle line against them at #myhl(places)[Gibeah]. 
#versenum(21) The people of #myname[Benjamin] came out of #myhl(places)[Gibeah] and destroyed on that day #mynumber[22,000] men of the #myname[Israelites]. 
...
#versenum(23) And the people of #myname[Israel] went up and wept before the #myhl(divine)[#smallcaps[Lord]] until the evening. And they inquired of the #myhl(divine)[#smallcaps[Lord]], “Shall we again draw near to fight against our brothers, the people of #myname[Benjamin]?” And the #myhl(divine)[#smallcaps[Lord]] said, “Go up against them.”


  
#versenum(24) So the people of #myname[Israel] came near against the people of #myname[Benjamin] the #mynumber[second] day. 
#versenum(25) And #myname[Benjamin] went against them out of #myhl(places)[Gibeah] the #mynumber[second] day, and destroyed #underline[#mynumber[18,000]] men of the people of #myname[Israel]. All these were men who drew the sword. 
#versenum(26) Then all the people of #myname[Israel], the whole army, went up and came to #myhl(places)[Bethel] and wept. They sat there before the #myhl(divine)[#smallcaps[Lord]] and #underline[fasted] that day until evening, and offered burnt offerings and peace offerings before the #myhl(divine)[#smallcaps[Lord]]. 
#versenum(27) And the people of #myname[Israel] inquired of the #myhl(divine)[#smallcaps[Lord]] (for the ark of the covenant of #myhl(divine)[God] was there in those days, 
#versenum(28) and #myhl(men)[Phinehas] the son of #myhl(men)[Eleazar], son of #myhl(men)[Aaron], #underline[ministered] before it in those days), saying, “Shall we go out once more to battle against our brothers, the people of #myname[Benjamin], or shall we cease?” And the #myhl(divine)[#smallcaps[Lord]] said, “Go up, for tomorrow I will give them into your hand.”


  
#versenum(29) So #myname[Israel] set men in ambush around #myhl(places)[Gibeah]. 
#versenum(30) And the people of #myname[Israel] went up against the people of #myname[Benjamin] on the #mynumber[third] day and set themselves in array against #myhl(places)[Gibeah], as at other times. 
#versenum(31) And the people of #myname[Benjamin] went out against the people and were drawn away from the city. And as at other times they began to strike and kill some of the people in the highways, one of which goes up to #myhl(places)[Bethel] and the other to #myhl(places)[Gibeah], and in the open country, about #mynumber[thirty] men of #myname[Israel]. 
...
#versenum(33) And all the men of #myname[Israel] rose up out of their place and set themselves in array at #underline[#myname[Baal-tamar]], and the men of #myname[Israel] who were in ambush rushed out of their place from #underline[#myhl(places)[Maareh-geba]].#footnote[Judges 20:33 Some Septuagint manuscripts #emph[place west of Geba]] 
#versenum(34) And there came against #myhl(places)[Gibeah] #mynumber[10,000] chosen men out of all #myname[Israel], and the battle was hard, but the #myname[Benjaminites] did not know that disaster was close upon them. 
#versenum(35) And the #myhl(divine)[#smallcaps[Lord]] defeated #myname[Benjamin] before #myname[Israel], and the people of #myname[Israel] destroyed #underline[#mynumber[25,100]] men of #myname[Benjamin] that day. All these were men who drew the sword. 
#versenum(36) So the people of #myname[Benjamin] saw that they were defeated.


  The men of #myname[Israel] gave ground to #myname[Benjamin], because they #underline[trusted] the men in ambush whom they had set against #myhl(places)[Gibeah]. 
...
#versenum(43) Surrounding the #myname[Benjaminites], they pursued them and trod them down from #underline[#myhl(places)[Nohah]]#footnote[Judges 20:43 Septuagint; Hebrew \[at their\] #emph[resting place]] as far as opposite #myhl(places)[Gibeah] on the east. 
#versenum(44) #mynumber[Eighteen thousand] men of #myname[Benjamin] fell, all of them men of valor. 
#versenum(45) And they turned and fled toward the wilderness to the #myhl(places)[rock of Rimmon]. #mynumber[Five thousand] men of them were cut down in the highways. And they were pursued hard to #underline[#myhl(places)[Gidom]], and #mynumber[2,000] men of them were struck down. 
...
#versenum(47) But #mynumber[600] men turned and fled toward the wilderness to the #myhl(places)[rock of Rimmon] and remained at the #myhl(places)[rock of Rimmon] #mynumber[four] months. 
...
#versenum(1) Now the men of #myname[Israel] had sworn at #myhl(places)[Mizpah], “No one of us shall give his daughter in marriage to #myname[Benjamin].” 
...
#versenum(5) And the people of #myname[Israel] said, “Which of all the tribes of #myname[Israel] did not come up in the assembly to the #myhl(divine)[#smallcaps[Lord]]?” For they had taken a great oath concerning him who did not come up to the #myhl(divine)[#smallcaps[Lord]] to #myhl(places)[Mizpah], saying, “He shall surely be put to death.” 
...
#versenum(8) And they said, “What one is there of the tribes of #myname[Israel] that did not come up to the #myhl(divine)[#smallcaps[Lord]] to #myhl(places)[Mizpah]?” And behold, no one had come to the camp from #myhl(places)[Jabesh-gilead], to the assembly. 
#versenum(9) For when the people were mustered, behold, not one of the inhabitants of #myhl(places)[Jabesh-gilead] was there. 
#versenum(10) So the congregation sent #mynumber[12,000] of their #underline[bravest] men there and commanded them, “Go and strike the inhabitants of #myhl(places)[Jabesh-gilead] with the edge of the sword; also the women and the little ones. 
...
#versenum(12) And they found among the inhabitants of #myhl(places)[Jabesh-gilead] #underline[#mynumber[400]] young #underline[virgins] who had not known a man by lying with him, and they brought them to the camp at #myhl(places)[Shiloh], which is in the land of #myhl(places)[Canaan].


  
#versenum(13) Then the whole congregation sent word to the people of #myname[Benjamin] who were at the #myhl(places)[rock of Rimmon] and #underline[proclaimed] peace to them. 
#versenum(14) And #myname[Benjamin] returned at that time. And they gave them the women whom they had saved alive of the women of #myhl(places)[Jabesh-gilead], but they were not enough for them. 
#versenum(15) And the people had compassion on #myname[Benjamin] because the #myhl(divine)[#smallcaps[Lord]] had made a breach in the tribes of #myname[Israel].
...
#versenum(21) and watch. If the daughters of #myhl(places)[Shiloh] come out to #underline[dance] in the dances, then come out of the vineyards and #underline[snatch] each man his wife from the daughters of #myhl(places)[Shiloh], and go to the land of #myname[Benjamin]. 
...
#versenum(1) In the days when the judges ruled there was a #underline[famine] in the land, and a man of #myhl(places)[Bethlehem in Judah] went to sojourn in the country of #myhl(places)[Moab], he and his wife and his #mynumber[two] sons. 
#versenum(2) The name of the man was #myhl(men)[Elimelech] and the name of his wife #myhl(women)[Naomi], and the names of his #mynumber[two] sons were #myhl(men)[Mahlon] and #myhl(men)[Chilion]. They were #underline[#myname[Ephrathites]] from #myhl(places)[Bethlehem in Judah]. They went into the country of #myhl(places)[Moab] and remained there. 
#versenum(3) But #myhl(men)[Elimelech], the husband of #myhl(women)[Naomi], died, and she was left with her #mynumber[two] sons. 
#versenum(4) These took #myname[Moabite] wives; the name of the one was #myhl(women)[Orpah] and the name of the other #myhl(women)[Ruth]. They lived there about #mynumber[ten] years, 
#versenum(5) and both #myhl(men)[Mahlon] and #myhl(men)[Chilion] died, so that the woman was left without her #mynumber[two] sons and her husband.
...
#versenum(8) But #myhl(women)[Naomi] said to her #mynumber[two] daughters-in-law, “Go, return each of you to her mother’s house. May the #myhl(divine)[#smallcaps[Lord]] deal kindly with you, as you have dealt with the dead and with me. 
...
#versenum(19) So the #mynumber[two] of them went on until they came to #myhl(places)[Bethlehem]. And when they came to #myhl(places)[Bethlehem], the whole town was #underline[stirred] because of them. And the women said, “Is this #myhl(women)[Naomi]?” 
...
#versenum(22) So #myhl(women)[Naomi] returned, and #myhl(women)[Ruth] the #myname[Moabite] her daughter-in-law with her, who returned from the country of #myhl(places)[Moab]. And they came to #myhl(places)[Bethlehem] at the beginning of barley harvest.
...
#versenum(2) And #myhl(women)[Ruth] the #myname[Moabite] said to #myhl(women)[Naomi], “Let me go to the field and glean among the ears of grain after him in whose sight I shall find favor.” And she said to her, “Go, my daughter.” 
...
#versenum(6) And the servant who was in charge of the reapers answered, “She is the young #myname[Moabite] woman, who came back with #myhl(women)[Naomi] from the country of #myhl(places)[Moab]. 
...
#versenum(21) And #myhl(women)[Ruth] the #myname[Moabite] said, “Besides, he said to me, ‘You shall keep close by my young men until they have finished all my harvest.’” 
...
#versenum(10) And he said, “May you be blessed by the #myhl(divine)[#smallcaps[Lord]], my daughter. You have made this last kindness greater than the #mynumber[first] in that you have not gone after young men, whether #underline[poor] or rich. 
...
#versenum(5) Then #myhl(men)[Boaz] said, “The day you buy the field from the hand of #myhl(women)[Naomi], you also #underline[acquire] #myhl(women)[Ruth]#footnote[Ruth 4:5 Masoretic Text #emph[you also buy it from Ruth]] the #myname[Moabite], the widow of the dead, in order to perpetuate the name of the dead in his inheritance.” 
...
#versenum(10) Also #myhl(women)[Ruth] the #myname[Moabite], the widow of #myhl(men)[Mahlon], I have bought to be my wife, to perpetuate the name of the dead in his inheritance, that the name of the dead may not be cut off from among his brothers and from the gate of his native place. You are witnesses this day.” 
#versenum(11) Then all the people who were at the gate and the elders said, “We are witnesses. May the #myhl(divine)[#smallcaps[Lord]] make the woman, who is coming into your house, like #underline[#myhl(women)[Rachel]] and #underline[#myhl(women)[Leah]], who together built up the house of #myname[Israel]. May you act #underline[worthily] in #underline[#myhl(places)[Ephrathah]] and be renowned in #myhl(places)[Bethlehem], 
#versenum(12) and may your house be like the house of #myhl(men)[Perez], whom #underline[#myhl(women)[Tamar]] bore to #myname[Judah], because of the offspring that the #myhl(divine)[#smallcaps[Lord]] will give you by this young woman.”
