...
#let namesColor  = rgb(204, 153, 255)
...
#versenum(4) Then #myhl(men)[Joshua] called the #mynumber[twelve] men from the #myhl(people-groups)[people of Israel], whom he had appointed, a man from each tribe. 
...
#versenum(8) And the #myhl(people-groups)[people of Israel] did just as #myhl(men)[Joshua] commanded and took up #mynumber[twelve] stones out of the midst of the #myhl(places)[Jordan], according to the number of the tribes of the #myhl(people-groups)[people of Israel], just as the #myhl(divine)[#smallcaps[Lord]] told #myhl(men)[Joshua]. And they carried them over with them to the place where they lodged and laid them down#footnote[Joshua 4:8 Or #emph[to rest]] there. 
...
#versenum(12) The sons of #myname[Reuben] and the sons of #myname[Gad] and the #mynumber[half]-tribe of #myname[Manasseh] passed over armed before the #myhl(people-groups)[people of Israel], as #myhl(men)[Moses] had told them. 
...
#versenum(1) As soon as all the kings of the #myname[Amorites] who were beyond the #myhl(places)[Jordan] to the west, and all the kings of the #myname[Canaanites] who were by the sea, heard that the #myhl(divine)[#smallcaps[Lord]] had dried up the waters of the #myhl(places)[Jordan] for the #myhl(people-groups)[people of Israel] until they had crossed over, their hearts melted and there was no longer any spirit in them because of the #myhl(people-groups)[people of Israel].
...
#versenum(10) While the #myhl(people-groups)[people of Israel] were encamped at #myhl(places)[Gilgal], they kept the #myname[Passover] on the #underline[#mynumber[fourteenth]] day of the month in the evening on the plains of #myhl(places)[Jericho]. 
...
#versenum(1) But the #myhl(people-groups)[people of Israel] broke faith in regard to the devoted things, for #myhl(men)[Achan] the son of #myhl(men)[Carmi], son of #myhl(men)[Zabdi], son of #myhl(men)[Zerah], of the tribe of #myname[Judah], took some of the devoted things. And the anger of the #myhl(divine)[#smallcaps[Lord]] burned against the #myhl(people-groups)[people of Israel].
...
#versenum(33) And all #myname[Israel], #underline[sojourner] as well as native born, with their elders and officers and their judges, stood on opposite sides of the ark before the Levitical priests who carried the ark of the covenant of the #myhl(divine)[#smallcaps[Lord]], #mynumber[half] of them in front of #myhl(places)[Mount Gerizim] and #mynumber[half] of them in front of #myhl(places)[Mount Ebal], just as #myhl(men)[Moses] the servant of the #myhl(divine)[#smallcaps[Lord]] had commanded at the first, to bless the #myhl(people-groups)[people of Israel]. 
...
#versenum(7) But the #myhl(people-groups)[men of Israel] said to the #myname[Hivites], “#underline[Perhaps] you live among us; then how can we make a covenant with you?” 
...
#versenum(17) And the #myhl(people-groups)[people of Israel] set out and reached their cities on the #mynumber[third] day. Now their cities were #myhl(places)[Gibeon], #myhl(places)[Chephirah], #myhl(places)[Beeroth], and #myhl(places)[Kiriath-jearim]. 
...
#versenum(19) There was not a city that made peace with the #myhl(people-groups)[people of Israel] except the #myname[Hivites], the inhabitants of #myhl(places)[Gibeon]. They took them all in battle. 
...
#versenum(22) There was none of the #myname[Anakim] left in the land of the #myhl(people-groups)[people of Israel]. Only in #myhl(places)[Gaza], in Gath, and in #myhl(places)[Ashdod] did some remain. 
...
#versenum(6) #myhl(men)[Moses], the servant of the #myhl(divine)[#smallcaps[Lord]], and the #myhl(people-groups)[people of Israel] defeated them. And #myhl(men)[Moses] the servant of the #myhl(divine)[#smallcaps[Lord]] gave their land for a possession to the #myname[Reubenites] and the #myname[Gadites] and the #mynumber[half]-tribe of #myname[Manasseh].
...
#versenum(6) all the inhabitants of the hill country from #myhl(places)[Lebanon] to #myhl(places)[Misrephoth-maim], even all the #myname[Sidonians]. I myself will drive them out from before the #myhl(people-groups)[people of Israel]. Only #underline[allot] the land to #myname[Israel] for an inheritance, as I have commanded you. 
...
#versenum(13) Yet the #myhl(people-groups)[people of Israel] did not drive out the #myname[Geshurites] or the #myname[Maacathites], but #underline[#myhl(places)[Geshur]] and #underline[#myhl(places)[Maacath]] dwell in the midst of #myname[Israel] to this day.
...
#versenum(21) that is, all the cities of the tableland, and all the kingdom of #myhl(men)[Sihon] king of the #myname[Amorites], who reigned in #myhl(places)[Heshbon], whom #myhl(men)[Moses] defeated with the leaders of #myhl(places)[Midian], #underline[#myhl(men)[Evi]] and #myhl(men)[Rekem] and #underline[#myhl(men)[Zur]] and #underline[#myhl(men)[Hur]] and #underline[#myhl(men)[Reba]], the princes of #myhl(men)[Sihon], who lived in the land. 
...
#versenum(4) For the people of #myhl(men)[Joseph] were #mynumber[two] tribes, #myname[Manasseh] and #myname[Ephraim]. And no portion was given to the #myname[Levites] in the land, but only cities to dwell in, with their pasturelands for their livestock and their #underline[substance]. 
...
#versenum(4) The people of #myhl(men)[Joseph], #myname[Manasseh] and #myname[Ephraim], received their inheritance.
...
#versenum(13) Now when the #myhl(people-groups)[people of Israel] grew strong, they put the #myname[Canaanites] to forced labor, but did not utterly drive them out.
...
#versenum(16) The people of #myhl(men)[Joseph] said, “The hill country is not enough for us. Yet all the #myname[Canaanites] who dwell in the plain have chariots of iron, both those in #myhl(places)[Beth-shean] and its villages and those in the #myhl(places)[Valley of Jezreel].” 
#versenum(17) Then #myhl(men)[Joshua] said to the house of #myhl(men)[Joseph], to #myname[Ephraim] and #myname[Manasseh], “You are a numerous people and have great power. You shall not have one allotment only, 
...
#versenum(2) There remained among the #myhl(people-groups)[people of Israel] #mynumber[seven] tribes whose inheritance had not yet been apportioned. 
...
#versenum(5) They shall divide it into #mynumber[seven] portions. #myname[Judah] shall continue in his territory on the south, and the house of #myhl(men)[Joseph] shall continue in their territory on the north. 
...
#versenum(11) The lot of the tribe of the people of #myhl(men)[Benjamin] according to its clans came up, and the territory allotted to it fell between the people of #myname[Judah] and the people of #myhl(men)[Joseph]. 
...
#versenum(28) #underline[#myhl(places)[Zela]], #underline[#myhl(places)[Haeleph]], #myhl(places)[Jebus]#footnote[Joshua 18:28 Septuagint, Syriac, Vulgate; Hebrew #emph[the Jebusite]] (that is, #myhl(places)[Jerusalem]), #myhl(places)[Gibeah]#footnote[Joshua 18:28 Hebrew #emph[Gibeath]] and #myhl(places)[Kiriath-jearim]#footnote[Joshua 18:28 Septuagint; Hebrew #emph[Kiriath]]—#mynumber[fourteen] cities with their villages. This is the inheritance of the people of #myhl(men)[Benjamin] according to its clans.
...
#versenum(1) The #mynumber[second] lot came out for #myhl(men)[Simeon], for the tribe of the people of #myhl(men)[Simeon], according to their clans, and their inheritance was in the midst of the inheritance of the people of #myname[Judah]. 
...
#versenum(9) The inheritance of the people of #myhl(men)[Simeon] formed part of the territory of the people of #myname[Judah]. Because the portion of the people of #myname[Judah] was too large for them, the people of #myhl(men)[Simeon] #underline[obtained] an inheritance in the midst of their inheritance.
...
#versenum(1) Then the heads of the fathers’ houses of the #myname[Levites] came to #myhl(men)[Eleazar] the priest and to #myhl(men)[Joshua] the son of #myhl(men)[Nun] and to the heads of the fathers’ houses of the tribes of the #myhl(people-groups)[people of Israel]. 
...
#versenum(3) So by command of the #myhl(divine)[#smallcaps[Lord]] the #myhl(people-groups)[people of Israel] gave to the #myname[Levites] the following cities and pasturelands out of their inheritance.


  
#versenum(4) The lot came out for the clans of the #myname[Kohathites]. So those #myname[Levites] who were descendants of #myhl(men)[Aaron] the priest received by lot from the tribes of #myname[Judah], #myhl(men)[Simeon], and #myhl(men)[Benjamin], #mynumber[thirteen] cities.
...
#versenum(8) These cities and their pasturelands the #myhl(people-groups)[people of Israel] gave by lot to the #myname[Levites], as the #myhl(divine)[#smallcaps[Lord]] had commanded through #myhl(men)[Moses].


  
#versenum(9) Out of the tribe of the people of #myname[Judah] and the tribe of the people of #myhl(men)[Simeon] they gave the following cities #underline[mentioned] by name, 
...
#versenum(41) The cities of the #myname[Levites] in the midst of the possession of the #myhl(people-groups)[people of Israel] were in all #underline[#mynumber[forty-eight]] cities with their pasturelands. 
...
#versenum(9) So the people of #myname[Reuben] and the people of #myname[Gad] and the #mynumber[half]-tribe of #myname[Manasseh] returned home, #underline[parting] from the #myhl(people-groups)[people of Israel] at #myhl(places)[Shiloh], which is in the land of #myhl(places)[Canaan], to go to the land of #myhl(places)[Gilead], their own land of which they had #underline[possessed] themselves by command of the #myhl(divine)[#smallcaps[Lord]] through #myhl(men)[Moses].
...
#versenum(11) And the #myhl(people-groups)[people of Israel] heard it said, “Behold, the people of #myname[Reuben] and the people of #myname[Gad] and the #mynumber[half]-tribe of #myname[Manasseh] have built the altar at the #underline[frontier] of the land of #myhl(places)[Canaan], in the region about the #myhl(places)[Jordan], on the side that belongs to the #myhl(people-groups)[people of Israel].” 
...
#versenum(13) Then the #myhl(people-groups)[people of Israel] sent to the people of #myname[Reuben] and the people of #myname[Gad] and the #mynumber[half]-tribe of #myname[Manasseh], in the land of #myhl(places)[Gilead], #myhl(men)[Phinehas] the son of #myhl(men)[Eleazar] the priest, 
...
#versenum(32) Then #myhl(men)[Phinehas] the son of #myhl(men)[Eleazar] the priest, and the chiefs, returned from the people of #myname[Reuben] and the people of #myname[Gad] in the land of #myhl(places)[Gilead] to the land of #myhl(places)[Canaan], to the #myhl(people-groups)[people of Israel], and brought back word to them. 
#versenum(33) And the report was good in the eyes of the #myhl(people-groups)[people of Israel]. And the #myhl(people-groups)[people of Israel] blessed #myhl(divine)[God] and spoke no more of making war against them to destroy the land where the people of #myname[Reuben] and the people of #myname[Gad] were settled. 
...
#versenum(32) As for the #underline[bones] of #myhl(men)[Joseph], which the #myhl(people-groups)[people of Israel] brought up from #myhl(places)[Egypt], they buried them at #myhl(places)[Shechem], in the #underline[piece] of land that #myhl(men)[Jacob] bought from the sons of #myhl(men)[Hamor] the father of #myhl(places)[Shechem] for a #mynumber[hundred] pieces of money.#footnote[Joshua 24:32 Hebrew #emph[for a hundred qesitah]; a unit of money of uncertain value] It became an inheritance of the descendants of #myhl(men)[Joseph].
...
#versenum(1) After the death of #myhl(men)[Joshua], the #myhl(people-groups)[people of Israel] inquired of the #myhl(divine)[#smallcaps[Lord]], “Who shall go up #mynumber[first] for us against the #myname[Canaanites], to fight against them?” 
#versenum(2) The #myhl(divine)[#smallcaps[Lord]] said, “#myname[Judah] shall go up; behold, I have given the land into his hand.” 
#versenum(3) And #myname[Judah] said to #myhl(men)[Simeon] his brother, “Come up with me into the territory allotted to me, that we may fight against the #myname[Canaanites]. And I likewise will go with you into the territory allotted to you.” So #myhl(men)[Simeon] went with him. 
...
#versenum(17) And #myname[Judah] went with #myhl(men)[Simeon] his brother, and they defeated the #myname[Canaanites] who inhabited #underline[#myhl(places)[Zephath]] and devoted it to destruction. So the name of the city was called #myhl(places)[Hormah].#footnote[Judges 1:17 #emph[Hormah] means #emph[utter destruction]] 
...
#versenum(21) But the people of #myhl(men)[Benjamin] did not drive out the #myname[Jebusites] who lived in #myhl(places)[Jerusalem], so the #myname[Jebusites] have lived with the people of #myhl(men)[Benjamin] in #myhl(places)[Jerusalem] to this day.
...
#versenum(35) The #myname[Amorites] persisted in dwelling in #myhl(places)[Mount Heres], in #myhl(places)[Aijalon], and in #underline[#myhl(places)[Shaalbim]], but the hand of the house of #myhl(men)[Joseph] rested #underline[heavily] on them, and they became subject to forced labor. 
...
#versenum(11) And the #myhl(people-groups)[people of Israel] did what was evil in the sight of the #myhl(divine)[#smallcaps[Lord]] and served the #myname[Baals]. 
...
#versenum(5) So the #myhl(people-groups)[people of Israel] lived among the #myname[Canaanites], the #myname[Hittites], the #myname[Amorites], the #myname[Perizzites], the #myname[Hivites], and the #myname[Jebusites]. 
...
#versenum(7) And the #myhl(people-groups)[people of Israel] did what was evil in the sight of the #myhl(divine)[#smallcaps[Lord]]. They #underline[forgot] the #myhl(divine)[#smallcaps[Lord]] their #myhl(divine)[God] and served the #myname[Baals] and the #underline[#myname[Asheroth]]. 
#versenum(8) Therefore the anger of the #myhl(divine)[#smallcaps[Lord]] was kindled against #myname[Israel], and he sold them into the hand of #myhl(men)[Cushan-rishathaim] king of #myhl(places)[Mesopotamia]. And the #myhl(people-groups)[people of Israel] served #myhl(men)[Cushan-rishathaim] #mynumber[eight] years. 
...
#versenum(10) The #myhl(divine)[Spirit] of the #myhl(divine)[#smallcaps[Lord]] was upon him, and he judged #myname[Israel]. He went out to war, and the #myhl(divine)[#smallcaps[Lord]] gave #myhl(men)[Cushan-rishathaim] king of #myhl(places)[Mesopotamia] into his hand. And his hand #underline[prevailed] over #myhl(men)[Cushan-rishathaim]. 
...
#versenum(14) And the #myhl(people-groups)[people of Israel] served #myhl(men)[Eglon] the king of #myhl(places)[Moab] #mynumber[eighteen] years.


  
#versenum(15) Then the #myhl(people-groups)[people of Israel] cried out to the #myhl(divine)[#smallcaps[Lord]], and the #myhl(divine)[#smallcaps[Lord]] raised up for them a deliverer, #myhl(men)[Ehud], the son of #underline[#myhl(men)[Gera]], the #underline[#myname[Benjaminite]], a left-handed man. The #myhl(people-groups)[people of Israel] sent tribute by him to #myhl(men)[Eglon] the king of #myhl(places)[Moab]. 
...
#versenum(3) Then the #myhl(people-groups)[people of Israel] cried out to the #myhl(divine)[#smallcaps[Lord]] for help, for he had #mynumber[900] chariots of iron and he oppressed the #myhl(people-groups)[people of Israel] #underline[cruelly] for #mynumber[twenty] years.
...
#versenum(1) The #myhl(people-groups)[people of Israel] did what was evil in the sight of the #myhl(divine)[#smallcaps[Lord]], and the #myhl(divine)[#smallcaps[Lord]] gave them into the hand of #myhl(places)[Midian] #mynumber[seven] years. 
#versenum(2) And the hand of #myhl(places)[Midian] #underline[overpowered] #myname[Israel], and because of #myhl(places)[Midian] the #myhl(people-groups)[people of Israel] made for themselves the #underline[dens] that are in the mountains and the #underline[caves] and the #underline[strongholds]. 
#versenum(3) For whenever the #myhl(people-groups)[Israelites] #underline[planted] #underline[crops], the #myname[Midianites] and the #myname[Amalekites] and the people of the East would come up against them. 
...
#versenum(6) And #myname[Israel] was brought very low because of #myhl(places)[Midian]. And the #myhl(people-groups)[people of Israel] cried out for help to the #myhl(divine)[#smallcaps[Lord]].


  
#versenum(7) When the #myhl(people-groups)[people of Israel] cried out to the #myhl(divine)[#smallcaps[Lord]] on account of the #myname[Midianites], 
...
#versenum(14) And the #myhl(divine)[#smallcaps[Lord]]#footnote[Judges 6:14 Septuagint #emph[the angel of the Lord]; also verse 16] turned to him and said, “Go in this might of yours and save #myname[Israel] from the hand of #myhl(places)[Midian]; do not I send you?” 
#versenum(15) And he said to him, “Please, #myhl(divine)[Lord], how can I save #myname[Israel]? Behold, my clan is the #underline[weakest] in #myhl(places)[Manasseh], and I am the #underline[least] in my father’s house.” 
...
#versenum(14) And his comrade answered, “This is no other than the sword of #myhl(men)[Gideon] the son of #myhl(men)[Joash], a man of #myname[Israel]; #myhl(divine)[God] has given into his hand #myhl(places)[Midian] and all the camp.”
...
#versenum(23) And the #myhl(people-groups)[men of Israel] were called out from #myname[Naphtali] and from #myname[Asher] and from all #myname[Manasseh], and they pursued after #myhl(places)[Midian].
...
#versenum(1) Then the men of #myname[Ephraim] said to him, “What is this that you have done to us, not to call us when you went to fight against #myhl(places)[Midian]?” And they #underline[accused] him #underline[fiercely]. 
...
#versenum(12) And #myhl(men)[Zebah] and #myhl(men)[Zalmunna] fled, and he pursued them and captured the #mynumber[two] kings of #myhl(places)[Midian], #myhl(men)[Zebah] and #myhl(men)[Zalmunna], and he threw all the army into a panic.
...
#versenum(28) So #myhl(places)[Midian] was subdued before the #myhl(people-groups)[people of Israel], and they raised their heads no more. And the land had rest for #mynumber[forty] years in the days of #myhl(men)[Gideon].
...
#versenum(33) As soon as #myhl(men)[Gideon] died, the #myhl(people-groups)[people of Israel] turned again and whored after the #myname[Baals] and made #myname[Baal-berith] their god. 
...
#versenum(8) and they crushed and oppressed the #myhl(people-groups)[people of Israel] that year. For #mynumber[eighteen] years they oppressed all the #myhl(people-groups)[people of Israel] who were beyond the #myhl(places)[Jordan] in the land of the #myname[Amorites], which is in #myhl(places)[Gilead]. 
#versenum(9) And the #myname[Ammonites] crossed the #myhl(places)[Jordan] to fight also against #myname[Judah] and against #myhl(men)[Benjamin] and against the house of #myname[Ephraim], so that #myname[Israel] was #underline[severely] #underline[distressed].


  
#versenum(10) And the #myhl(people-groups)[people of Israel] cried out to the #myhl(divine)[#smallcaps[Lord]], saying, “We have sinned against you, because we have forsaken our #myhl(divine)[God] and have served the #myname[Baals].” 
#versenum(11) And the #myhl(divine)[#smallcaps[Lord]] said to the #myhl(people-groups)[people of Israel], “Did I not save you from the #myhl(people-groups)[Egyptians] and from the #myname[Amorites], from the #myname[Ammonites] and from the #myname[Philistines]? 
...
#versenum(17) Then the #myname[Ammonites] were called to arms, and they encamped in #myhl(places)[Gilead]. And the #myhl(people-groups)[people of Israel] came together, and they encamped at #myhl(places)[Mizpah]. 
...
#versenum(27) I therefore have not sinned against you, and you do me #underline[wrong] by making war on me. The #myhl(divine)[#smallcaps[Lord]], the Judge, #underline[decide] this day between the #myhl(people-groups)[people of Israel] and the people of #underline[#myname[Ammon]].” 
...
#versenum(33) And he struck them from #myhl(places)[Aroer] to the neighborhood of #underline[#myhl(places)[Minnith]], #mynumber[twenty] cities, and as far as #underline[#myhl(places)[Abel-keramim]], with a great blow. So the #myname[Ammonites] were subdued before the #myhl(people-groups)[people of Israel].
...
#versenum(1) And the #myhl(people-groups)[people of Israel] again did what was evil in the sight of the #myhl(divine)[#smallcaps[Lord]], so the #myhl(divine)[#smallcaps[Lord]] gave them into the hand of the #myname[Philistines] for #mynumber[forty] years.
...
#versenum(7) Now there was a young man of #myhl(places)[Bethlehem in Judah], of the family of #myname[Judah], who was a #myhl(people-groups)[Levite], and he #underline[sojourned] there. 
...
#versenum(10) And #myhl(men)[Micah] said to him, “Stay with me, and be to me a father and a priest, and I will give you #mynumber[ten] pieces of silver a year and a #underline[suit] of clothes and your living.” And the #myhl(people-groups)[Levite] went in. 
...
#versenum(10) and we will take #mynumber[ten] men of a #mynumber[hundred] throughout all the tribes of #myname[Israel], and a #mynumber[hundred] of a #mynumber[thousand], and a #mynumber[thousand of ten thousand], to bring provisions for the people, that when they come they may repay #myhl(places)[Gibeah] of #myhl(men)[Benjamin] for all the outrage that they have committed in #myhl(places)[Israel].” 
#versenum(11) So all the #myhl(people-groups)[men of Israel] gathered against the city, #underline[united] as one man.


  
#versenum(12) And the tribes of #myname[Israel] sent men through all the tribe of #myhl(men)[Benjamin], saying, “What evil is this that has taken place among you? 
#versenum(13) Now therefore give up the men, the worthless fellows in #myhl(places)[Gibeah], that we may put them to death and #underline[purge] evil from #myname[Israel].” But the #myname[Benjaminites] would not listen to the voice of their brothers, the #myhl(people-groups)[people of Israel]. 
...
#versenum(15) And the people of #myhl(men)[Benjamin] mustered out of their cities on that day #underline[#mynumber[26,000]] men who drew the sword, besides the inhabitants of #myhl(places)[Gibeah], who mustered #mynumber[700] chosen men. 
...
#versenum(17) And the #myhl(people-groups)[men of Israel], apart from #myhl(men)[Benjamin], mustered #mynumber[400,000] men who drew the sword; all these were men of war.


  
#versenum(18) The #myhl(people-groups)[people of Israel] arose and went up to #myhl(places)[Bethel] and inquired of #myhl(divine)[God], “Who shall go up #mynumber[first] for us to fight against the people of #myhl(men)[Benjamin]?” And the #myhl(divine)[#smallcaps[Lord]] said, “#myname[Judah] shall go up #mynumber[first].”
...
#versenum(21) The people of #myhl(men)[Benjamin] came out of #myhl(places)[Gibeah] and destroyed on that day #mynumber[22,000] men of the #myhl(people-groups)[Israelites]. 
#versenum(22) But the people, the #myhl(people-groups)[men of Israel], took #underline[courage], and again formed the battle line in the same place where they had formed it on the #mynumber[first] day. 
...
#versenum(24) So the #myhl(people-groups)[people of Israel] came near against the people of #myhl(men)[Benjamin] the #mynumber[second] day. 
#versenum(25) And #myhl(men)[Benjamin] went against them out of #myhl(places)[Gibeah] the #mynumber[second] day, and destroyed #underline[#mynumber[18,000]] men of the #myhl(people-groups)[people of Israel]. All these were men who drew the sword. 
...
#versenum(30) And the #myhl(people-groups)[people of Israel] went up against the people of #myhl(men)[Benjamin] on the #mynumber[third] day and set themselves in array against #myhl(places)[Gibeah], as at other times. 
#versenum(31) And the people of #myhl(men)[Benjamin] went out against the people and were drawn away from the city. And as at other times they began to strike and kill some of the people in the highways, one of which goes up to #myhl(places)[Bethel] and the other to #myhl(places)[Gibeah], and in the open country, about #mynumber[thirty] #myhl(people-groups)[men of Israel]. 
...
#versenum(33) And all the #myhl(people-groups)[men of Israel] rose up out of their place and set themselves in array at #underline[#myname[Baal-tamar]], and the #myhl(people-groups)[men of Israel] who were in ambush rushed out of their place from #underline[#myhl(places)[Maareh-geba]].#footnote[Judges 20:33 Some Septuagint manuscripts #emph[place west of Geba]] 
...
#versenum(35) And the #myhl(divine)[#smallcaps[Lord]] defeated #myhl(men)[Benjamin] before #myname[Israel], and the #myhl(people-groups)[people of Israel] destroyed #underline[#mynumber[25,100]] men of #myhl(men)[Benjamin] that day. All these were men who drew the sword. 
...
#versenum(39) the #myhl(people-groups)[men of Israel] should turn in battle. Now #myhl(men)[Benjamin] had #underline[begun] to strike and kill about #mynumber[thirty] #myhl(people-groups)[men of Israel]. They said, “Surely they are defeated before us, as in the #mynumber[first] battle.” 
...
#versenum(44) #mynumber[Eighteen thousand] men of #myhl(men)[Benjamin] fell, all of them men of valor. 
...
#versenum(46) So all who fell that day of #myhl(men)[Benjamin] were #underline[#mynumber[25,000]] men who drew the sword, all of them men of valor. 
...
#versenum(6) And the #myhl(people-groups)[people of Israel] had compassion for #myhl(men)[Benjamin] their brother and said, “One tribe is cut off from #myname[Israel] this day. 
...
#versenum(15) And the people had compassion on #myhl(men)[Benjamin] because the #myhl(divine)[#smallcaps[Lord]] had made a breach in the tribes of #myname[Israel].
...
#versenum(17) And they said, “There must be an inheritance for the #underline[survivors] of #myhl(men)[Benjamin], that a tribe not be #underline[blotted] out from #myname[Israel]. 
