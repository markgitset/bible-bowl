...
#versenum(7) The #myhl(divine)[#smallcaps[Lord]] said to #myhl(men)[Joshua], “Today I will begin to #underline[exalt] you in the sight of all #myhl(other)[Israel], that they may know that, as I was with #myhl(men)[Moses], so I will be with you. 
...
#versenum(12) Now therefore take #myhl(numbers)[twelve] men from the tribes of #myhl(other)[Israel], from each tribe a man. 
...
#versenum(17) Now the priests bearing the ark of the covenant of the #myhl(divine)[#smallcaps[Lord]] stood firmly on dry ground in the midst of the #myhl(places)[Jordan], and all #myhl(other)[Israel] was passing over on dry ground until all the nation finished passing over the #myhl(places)[Jordan].
...
#versenum(14) On that day the #myhl(divine)[#smallcaps[Lord]] #underline[exalted] #myhl(men)[Joshua] in the sight of all #myhl(other)[Israel], and they stood in awe of him just as they had stood in awe of #myhl(men)[Moses], all the days of his life.
...
#versenum(22) then you shall let your children know, ‘#myhl(other)[Israel] passed over this #myhl(places)[Jordan] on dry ground.’ 
...
#versenum(2) At that time the #myhl(divine)[#smallcaps[Lord]] said to #myhl(men)[Joshua], “Make flint knives and #underline[circumcise] the sons of #myhl(other)[Israel] a #myhl(numbers)[second] time.” 
#versenum(3) So #myhl(men)[Joshua] made flint knives and circumcised the sons of #myhl(other)[Israel] at #underline[#myhl(places)[Gibeath-haaraloth]].#footnote[Joshua 5:3 #emph[Gibeath-haaraloth] means #emph[the hill of the foreskins]] 
...
#versenum(6) Then #myhl(men)[Joshua] tore his clothes and fell to the earth on his face before the ark of the #myhl(divine)[#smallcaps[Lord]] until the evening, he and the elders of #myhl(other)[Israel]. And they put #underline[dust] on their heads. 
...
#versenum(8) O #myhl(divine)[Lord], what can I say, when #myhl(other)[Israel] has turned their backs before their enemies! 
...
#versenum(11) #myhl(other)[Israel] has sinned; they have transgressed my covenant that I commanded them; they have taken some of the devoted things; they have #underline[stolen] and #underline[lied] and put them among their own #underline[belongings]. 
...
#versenum(13) Get up! Consecrate the people and say, ‘Consecrate yourselves for tomorrow; for thus says the #myhl(divine)[#smallcaps[Lord], God of Israel], “There are devoted things in your midst, O #myhl(other)[Israel]. You cannot stand before your enemies until you take away the devoted things from among you.” 
...
#versenum(16) So #myhl(men)[Joshua] rose early in the morning and brought #myhl(other)[Israel] near tribe by tribe, and the tribe of #myhl(other)[Judah] was taken. 
...
#versenum(24) And #myhl(men)[Joshua] and all #myhl(other)[Israel] with him took #myhl(men)[Achan] the son of #myhl(men)[Zerah], and the silver and the cloak and the bar of gold, and his sons and daughters and his oxen and donkeys and sheep and his tent and all that he had. And they brought them up to the #myhl(places)[Valley of Achor]. 
#versenum(25) And #myhl(men)[Joshua] said, “Why did you bring trouble on us? The #myhl(divine)[#smallcaps[Lord]] #underline[brings] trouble on you today.” And all #myhl(other)[Israel] stoned him with stones. They burned them with fire and stoned them with stones. 
...
#versenum(10) #myhl(men)[Joshua] arose early in the morning and mustered the people and went up, he and the elders of #myhl(other)[Israel], before the people to #myhl(places)[Ai]. 
...
#versenum(14) And as soon as the king of #myhl(places)[Ai] saw this, he and all his people, the men of the city, hurried and went out early to the appointed place#footnote[Joshua 8:14 Hebrew #emph[appointed time]] toward the #myhl(places)[Arabah] to meet #myhl(other)[Israel] in battle. But he did not know that there was an ambush against him behind the city. 
#versenum(15) And #myhl(men)[Joshua] and all #myhl(other)[Israel] #underline[pretended] to be #underline[beaten] before them and fled in the direction of the wilderness. 
...
#versenum(17) Not a man was left in #myhl(places)[Ai] or #myhl(places)[Bethel] who did not go out after #myhl(other)[Israel]. They left the city open and pursued #myhl(other)[Israel].
...
#versenum(21) And when #myhl(men)[Joshua] and all #myhl(other)[Israel] saw that the ambush had captured the city, and that the smoke of the city went up, then they turned back and struck down the men of #myhl(places)[Ai]. 
#versenum(22) And the others came out from the city against them, so they were in the midst of #myhl(other)[Israel], some on this side, and some on that side. And #myhl(other)[Israel] struck them down, until there was left none that #underline[survived] or escaped. 
#versenum(23) But the king of #myhl(places)[Ai] they took alive, and brought him near to #myhl(men)[Joshua].


  
#versenum(24) When #myhl(other)[Israel] had finished killing all the inhabitants of #myhl(places)[Ai] in the open wilderness where they pursued them, and all of them to the very last had fallen by the edge of the sword, all #myhl(other)[Israel] returned to #myhl(places)[Ai] and struck it down with the edge of the sword. 
...
#versenum(27) Only the livestock and the spoil of that city #myhl(other)[Israel] took as their plunder, according to the word of the #myhl(divine)[#smallcaps[Lord]] that he commanded #myhl(men)[Joshua]. 
...
#versenum(35) There was not a word of all that #myhl(men)[Moses] commanded that #myhl(men)[Joshua] did not read before all the assembly of #myhl(other)[Israel], and the women, and the little ones, and the #underline[sojourners] who lived#footnote[Joshua 8:35 Or #emph[traveled]] among them.
...
#versenum(2) they gathered together as one to fight against #myhl(men)[Joshua] and #myhl(other)[Israel].
...
#versenum(10) And the #myhl(divine)[#smallcaps[Lord]] threw them into a panic before #myhl(other)[Israel], who#footnote[Joshua 10:10 Or #emph[and he]] struck them with a great blow at #myhl(places)[Gibeon] and chased them by the way of the ascent of #myhl(places)[Beth-horon] and struck them as far as #myhl(places)[Azekah] and #myhl(places)[Makkedah]. 
#versenum(11) And as they fled before #myhl(other)[Israel], while they were going down the ascent of #myhl(places)[Beth-horon], the #myhl(divine)[#smallcaps[Lord]] threw down large stones from heaven on them as far as #myhl(places)[Azekah], and they died. There were more who died because of the #underline[hailstones] than the sons of #myhl(other)[Israel] killed with the sword.


  
#versenum(12) At that time #myhl(men)[Joshua] spoke to the #myhl(divine)[#smallcaps[Lord]] in the day when the #myhl(divine)[#smallcaps[Lord]] gave the #myhl(other)[Amorites] over to the sons of #myhl(other)[Israel], and he said in the sight of #myhl(other)[Israel],
...
#versenum(14) There has been no day like it before or since, when the #myhl(divine)[#smallcaps[Lord]] #underline[heeded] the voice of a man, for the #myhl(divine)[#smallcaps[Lord]] fought for #myhl(other)[Israel].


  
#versenum(15) So #myhl(men)[Joshua] returned, and all #myhl(other)[Israel] with him, to the camp at #myhl(places)[Gilgal].
...
#versenum(20) When #myhl(men)[Joshua] and the sons of #myhl(other)[Israel] had finished striking them with a great blow until they were #underline[wiped] out, and when the remnant that remained of them had entered into the fortified cities, 
...
#versenum(29) Then #myhl(men)[Joshua] and all #myhl(other)[Israel] with him passed on from #myhl(places)[Makkedah] to #myhl(places)[Libnah] and fought against #myhl(places)[Libnah]. 
#versenum(30) And the #myhl(divine)[#smallcaps[Lord]] gave it also and its king into the hand of #myhl(other)[Israel]. And he struck it with the edge of the sword, and every person in it; he left none remaining in it. And he did to its king as he had done to the king of #myhl(places)[Jericho].


  
#versenum(31) Then #myhl(men)[Joshua] and all #myhl(other)[Israel] with him passed on from #myhl(places)[Libnah] to #myhl(places)[Lachish] and laid siege to it and fought against it. 
#versenum(32) And the #myhl(divine)[#smallcaps[Lord]] gave #myhl(places)[Lachish] into the hand of #myhl(other)[Israel], and he captured it on the #myhl(numbers)[second] day and struck it with the edge of the sword, and every person in it, as he had done to #myhl(places)[Libnah].
...
#versenum(34) Then #myhl(men)[Joshua] and all #myhl(other)[Israel] with him passed on from #myhl(places)[Lachish] to #myhl(places)[Eglon]. And they laid siege to it and fought against it. 
...
#versenum(36) Then #myhl(men)[Joshua] and all #myhl(other)[Israel] with him went up from #myhl(places)[Eglon] to #myhl(places)[Hebron]. And they fought against it 
...
#versenum(38) Then #myhl(men)[Joshua] and all #myhl(other)[Israel] with him turned back to #myhl(places)[Debir] and fought against it 
...
#versenum(42) And #myhl(men)[Joshua] captured all these kings and their land at one time, because the #myhl(divine)[#smallcaps[Lord] God of Israel] fought for #myhl(other)[Israel]. 
#versenum(43) Then #myhl(men)[Joshua] returned, and all #myhl(other)[Israel] with him, to the camp at #myhl(places)[Gilgal].
...
#versenum(5) And all these kings #underline[joined] their forces and came and encamped together at the waters of #myhl(places)[Merom] to fight against #myhl(other)[Israel].


  
#versenum(6) And the #myhl(divine)[#smallcaps[Lord]] said to #myhl(men)[Joshua], “Do not be afraid of them, for tomorrow at this time I will give over all of them, slain, to #myhl(other)[Israel]. You shall #underline[hamstring] their horses and burn their chariots with fire.” 
...
#versenum(8) And the #myhl(divine)[#smallcaps[Lord]] gave them into the hand of #myhl(other)[Israel], who struck them and chased them as far as Great #myhl(places)[Sidon] and #myhl(places)[Misrephoth-maim], and eastward as far as the #myhl(places)[Valley of Mizpeh]. And they struck them until he left none remaining. 
...
#versenum(13) But none of the cities that stood on #underline[mounds] did #myhl(other)[Israel] burn, except #myhl(places)[Hazor] alone; that #myhl(men)[Joshua] burned. 
...
#versenum(20) For it was the #myhl(divine)[#smallcaps[Lord]]’s doing to #underline[harden] their hearts that they should come against #myhl(other)[Israel] in battle, in order that they should be devoted to destruction and should #underline[receive] no #underline[mercy] but be destroyed, just as the #myhl(divine)[#smallcaps[Lord]] commanded #myhl(men)[Moses].
...
#versenum(23) So #myhl(men)[Joshua] took the whole land, according to all that the #myhl(divine)[#smallcaps[Lord]] had spoken to #myhl(men)[Moses]. And #myhl(men)[Joshua] gave it for an inheritance to #myhl(other)[Israel] according to their tribal allotments. And the land had rest from war.
...
#versenum(6) all the inhabitants of the hill country from #myhl(places)[Lebanon] to #myhl(places)[Misrephoth-maim], even all the #myhl(other)[Sidonians]. I myself will drive them out from before the #myhl(people-groups)[people of Israel]. Only #underline[allot] the land to #myhl(other)[Israel] for an inheritance, as I have commanded you. 
...
#versenum(13) Yet the #myhl(people-groups)[people of Israel] did not drive out the #myhl(other)[Geshurites] or the #myhl(other)[Maacathites], but #underline[#myhl(places)[Geshur]] and #underline[#myhl(places)[Maacath]] dwell in the midst of #myhl(other)[Israel] to this day.
...
#versenum(10) And now, behold, the #myhl(divine)[#smallcaps[Lord]] has kept me alive, just as he said, these #underline[#myhl(numbers)[forty-five]] years since the time that the #myhl(divine)[#smallcaps[Lord]] spoke this word to #myhl(men)[Moses], while #myhl(other)[Israel] walked in the wilderness. And now, behold, I am this day #underline[#myhl(numbers)[eighty-five]] years old. 
...
#versenum(43) Thus the #myhl(divine)[#smallcaps[Lord]] gave to #myhl(other)[Israel] all the land that he swore to give to their fathers. And they took possession of it, and they settled there. 
...
#versenum(14) and with him #myhl(numbers)[ten] chiefs, one from each of the tribal families of #myhl(other)[Israel], every one of them the head of a family among the clans of #myhl(other)[Israel]. 
...
#versenum(18) that you too must turn away this day from following the #myhl(divine)[#smallcaps[Lord]]? And if you too rebel against the #myhl(divine)[#smallcaps[Lord]] today then tomorrow he will be angry with the whole congregation of #myhl(other)[Israel]. 
...
#versenum(20) Did not #myhl(men)[Achan] the son of #myhl(men)[Zerah] break faith in the matter of the devoted things, and wrath fell upon all the congregation of #myhl(other)[Israel]? And he did not perish alone for his #underline[iniquity].’”


  
#versenum(21) Then the people of #myhl(other)[Reuben], the people of #myhl(other)[Gad], and the #myhl(numbers)[half]-tribe of #myhl(other)[Manasseh] said in answer to the heads of the families of #myhl(other)[Israel], 
#versenum(22) “The Mighty One, #myhl(divine)[God], the #myhl(divine)[#smallcaps[Lord]]! The Mighty One, #myhl(divine)[God], the #myhl(divine)[#smallcaps[Lord]]! He #underline[knows]; and let #myhl(other)[Israel] itself know! If it was in rebellion or in breach of faith against the #myhl(divine)[#smallcaps[Lord]], do not #underline[spare] us today 
...
#versenum(30) When #myhl(men)[Phinehas] the priest and the chiefs of the congregation, the heads of the families of #myhl(other)[Israel] who were with him, heard the words that the people of #myhl(other)[Reuben] and the people of #myhl(other)[Gad] and the people of #myhl(other)[Manasseh] spoke, it was good in their eyes. 
...
#versenum(1) A long time afterward, when the #myhl(divine)[#smallcaps[Lord]] had given rest to #myhl(other)[Israel] from all their surrounding enemies, and #myhl(men)[Joshua] was old and well advanced in years, 
#versenum(2) #myhl(men)[Joshua] summoned all #myhl(other)[Israel], its elders and heads, its judges and officers, and said to them, “I am now old and well advanced in years. 
...
#versenum(1) #myhl(men)[Joshua] gathered all the tribes of #myhl(other)[Israel] to #myhl(places)[Shechem] and summoned the elders, the heads, the judges, and the officers of #myhl(other)[Israel]. And they presented themselves before #myhl(divine)[God]. 
...
#versenum(9) Then #myhl(men)[Balak] the son of #myhl(men)[Zippor], king of #myhl(places)[Moab], arose and fought against #myhl(other)[Israel]. And he sent and invited #myhl(men)[Balaam] the son of #myhl(men)[Beor] to curse you, 
...
#versenum(31) #myhl(other)[Israel] served the #myhl(divine)[#smallcaps[Lord]] all the days of #myhl(men)[Joshua], and all the days of the elders who outlived #myhl(men)[Joshua] and had known all the work that the #myhl(divine)[#smallcaps[Lord]] did for #myhl(other)[Israel].
...
#versenum(28) When #myhl(other)[Israel] grew strong, they put the #myhl(other)[Canaanites] to forced labor, but did not drive them out completely.
...
#versenum(7) And the people served the #myhl(divine)[#smallcaps[Lord]] all the days of #myhl(men)[Joshua], and all the days of the elders who outlived #myhl(men)[Joshua], who had seen all the great work that the #myhl(divine)[#smallcaps[Lord]] had done for #myhl(other)[Israel]. 
...
#versenum(10) And all that generation also were gathered to their fathers. And there arose another generation after them who did not know the #myhl(divine)[#smallcaps[Lord]] or the work that he had done for #myhl(other)[Israel].
...
#versenum(14) So the anger of the #myhl(divine)[#smallcaps[Lord]] was kindled against #myhl(other)[Israel], and he gave them over to #underline[plunderers], who plundered them. And he sold them into the hand of their surrounding enemies, so that they could no longer #underline[withstand] their enemies. 
...
#versenum(20) So the anger of the #myhl(divine)[#smallcaps[Lord]] was kindled against #myhl(other)[Israel], and he said, “Because this people have transgressed my covenant that I commanded their fathers and have not obeyed my voice, 
#versenum(21) I will no longer drive out before them any of the nations that #myhl(men)[Joshua] left when he died, 
#versenum(22) in order to test #myhl(other)[Israel] by them, whether they will take care to walk in the way of the #myhl(divine)[#smallcaps[Lord]] as their fathers did, or not.” 
...
#versenum(1) Now these are the nations that the #myhl(divine)[#smallcaps[Lord]] left, to test #myhl(other)[Israel] by them, that is, all in #myhl(places)[Israel] who had not #underline[experienced] all the #underline[wars] in #myhl(places)[Canaan]. 
...
#versenum(4) They were for the #underline[testing] of #myhl(other)[Israel], to know whether #myhl(other)[Israel] would obey the commandments of the #myhl(divine)[#smallcaps[Lord]], which he commanded their fathers by the hand of #myhl(men)[Moses]. 
...
#versenum(8) Therefore the anger of the #myhl(divine)[#smallcaps[Lord]] was kindled against #myhl(other)[Israel], and he sold them into the hand of #myhl(men)[Cushan-rishathaim] king of #myhl(places)[Mesopotamia]. And the #myhl(people-groups)[people of Israel] served #myhl(men)[Cushan-rishathaim] #myhl(numbers)[eight] years. 
...
#versenum(10) The #myhl(divine)[Spirit] of the #myhl(divine)[#smallcaps[Lord]] was upon him, and he judged #myhl(other)[Israel]. He went out to war, and the #myhl(divine)[#smallcaps[Lord]] gave #myhl(men)[Cushan-rishathaim] king of #myhl(places)[Mesopotamia] into his hand. And his hand #underline[prevailed] over #myhl(men)[Cushan-rishathaim]. 
...
#versenum(12) And the #myhl(people-groups)[people of Israel] again did what was evil in the sight of the #myhl(divine)[#smallcaps[Lord]], and the #myhl(divine)[#smallcaps[Lord]] strengthened #myhl(men)[Eglon] the king of #myhl(places)[Moab] against #myhl(other)[Israel], because they had done what was evil in the sight of the #myhl(divine)[#smallcaps[Lord]]. 
#versenum(13) He gathered to himself the #myhl(other)[Ammonites] and the #myhl(other)[Amalekites], and went and defeated #myhl(other)[Israel]. And they took possession of the city of palms. 
...
#versenum(30) So #myhl(places)[Moab] was subdued that day under the hand of #myhl(other)[Israel]. And the land had rest for #underline[#myhl(numbers)[eighty]] years.
...
#versenum(31) After him was #myhl(men)[Shamgar] the son of #myhl(men)[Anath], who killed #myhl(numbers)[600] of the #myhl(other)[Philistines] with an #underline[oxgoad], and he also saved #myhl(other)[Israel].
...
#versenum(4) Now #myhl(women)[Deborah], a #underline[prophetess], the wife of #underline[#myhl(men)[Lappidoth]], was #underline[judging] #myhl(other)[Israel] at that time. 
...
#versenum(9) My heart goes out to the commanders of #myhl(other)[Israel]\
...
#versenum(2) And the hand of #myhl(places)[Midian] #underline[overpowered] #myhl(other)[Israel], and because of #myhl(places)[Midian] the #myhl(people-groups)[people of Israel] made for themselves the #underline[dens] that are in the mountains and the #underline[caves] and the #underline[strongholds]. 
...
#versenum(6) And #myhl(other)[Israel] was brought very low because of #myhl(places)[Midian]. And the #myhl(people-groups)[people of Israel] cried out for help to the #myhl(divine)[#smallcaps[Lord]].
...
#versenum(14) And the #myhl(divine)[#smallcaps[Lord]]#footnote[Judges 6:14 Septuagint #emph[the angel of the Lord]; also verse 16] turned to him and said, “Go in this might of yours and save #myhl(other)[Israel] from the hand of #myhl(places)[Midian]; do not I send you?” 
#versenum(15) And he said to him, “Please, #myhl(divine)[Lord], how can I save #myhl(other)[Israel]? Behold, my clan is the #underline[weakest] in #myhl(places)[Manasseh], and I am the #underline[least] in my father’s house.” 
...
#versenum(36) Then #myhl(men)[Gideon] said to #myhl(divine)[God], “If you will save #myhl(other)[Israel] by my hand, as you have said, 
#versenum(37) behold, I am #underline[laying] a fleece of #underline[wool] on the threshing floor. If there is dew on the fleece alone, and it is dry on all the ground, then I shall know that you will save #myhl(other)[Israel] by my hand, as you have said.” 
...
#versenum(2) The #myhl(divine)[#smallcaps[Lord]] said to #myhl(men)[Gideon], “The people with you are too many for me to give the #myhl(other)[Midianites] into their hand, lest #myhl(other)[Israel] #underline[boast] over me, saying, ‘My own hand has saved me.’ 
...
#versenum(8) So the people took provisions in their hands, and their trumpets. And he sent all the rest of #myhl(other)[Israel] every man to his tent, but #underline[retained] the #myhl(numbers)[300] men. And #myhl(places)[the camp of Midian] was below him in the valley.
...
#versenum(14) And his comrade answered, “This is no other than the sword of #myhl(men)[Gideon] the son of #myhl(men)[Joash], a man of #myhl(other)[Israel]; #myhl(divine)[God] has given into his hand #myhl(places)[Midian] and all the camp.”
...
#versenum(27) And #myhl(men)[Gideon] made an ephod of it and put it in his city, in #myhl(places)[Ophrah]. And all #myhl(other)[Israel] whored after it there, and it became a snare to #myhl(men)[Gideon] and to his family. 
...
#versenum(35) and they did not show #underline[steadfast] love to the family of #myhl(men)[Jerubbaal] (that is, #myhl(men)[Gideon]) in return for all the good that he had done to #myhl(other)[Israel].
...
#versenum(22) #myhl(men)[Abimelech] ruled over #myhl(other)[Israel] #myhl(numbers)[three] years. 
...
#versenum(1) After #myhl(men)[Abimelech] there arose to save #myhl(other)[Israel] #underline[#myhl(men)[Tola]] the son of #underline[#myhl(men)[Puah]], son of #underline[#myhl(men)[Dodo]], a man of #myhl(other)[Issachar], and he lived at #myhl(places)[Shamir] in #myhl(places)[the hill country of Ephraim]. 
#versenum(2) And he judged #myhl(other)[Israel] #underline[#myhl(numbers)[twenty-three]] years. Then he died and was buried at #myhl(places)[Shamir].


  
#versenum(3) After him arose #myhl(men)[Jair] the #myhl(other)[Gileadite], who judged #myhl(other)[Israel] #myhl(numbers)[twenty-two] years. 
...
#versenum(7) So the anger of the #myhl(divine)[#smallcaps[Lord]] was kindled against #myhl(other)[Israel], and he sold them into the hand of the #myhl(other)[Philistines] and into the hand of the #myhl(other)[Ammonites], 
...
#versenum(9) And the #myhl(other)[Ammonites] crossed the #myhl(places)[Jordan] to fight also against #myhl(other)[Judah] and against #myhl(men)[Benjamin] and against the house of #myhl(other)[Ephraim], so that #myhl(other)[Israel] was #underline[severely] #underline[distressed].
...
#versenum(16) So they put away the foreign gods from among them and served the #myhl(divine)[#smallcaps[Lord]], and he became #underline[impatient] over the #underline[misery] of #myhl(other)[Israel].
...
#versenum(4) After a time the #myhl(other)[Ammonites] made war against #myhl(other)[Israel]. 
#versenum(5) And when the #myhl(other)[Ammonites] made war against #myhl(other)[Israel], the elders of #myhl(places)[Gilead] went to bring #myhl(men)[Jephthah] from the land of #myhl(other)[Tob]. 
...
#versenum(13) And the king of the #myhl(other)[Ammonites] answered the messengers of #myhl(men)[Jephthah], “Because #myhl(other)[Israel] on coming up from #myhl(places)[Egypt] took away my land, from the #myhl(places)[Arnon] to the #myhl(places)[Jabbok] and to the #myhl(places)[Jordan]; now therefore restore it #underline[peaceably].” 
#versenum(14) #myhl(men)[Jephthah] again sent messengers to the king of the #myhl(other)[Ammonites] 
#versenum(15) and said to him, “Thus says #myhl(men)[Jephthah]: #myhl(other)[Israel] did not take away the land of #myhl(places)[Moab] or the land of the #myhl(other)[Ammonites], 
#versenum(16) but when they came up from #myhl(places)[Egypt], #myhl(other)[Israel] went through the wilderness to the #myhl(places)[Red Sea] and came to #myhl(places)[Kadesh]. 
#versenum(17) #myhl(other)[Israel] then sent messengers to the king of #myhl(places)[Edom], saying, ‘Please let us pass through your land,’ but the king of #myhl(places)[Edom] would not listen. And they sent also to the king of #myhl(places)[Moab], but he would not #underline[consent]. So #myhl(other)[Israel] remained at #myhl(places)[Kadesh].
...
#versenum(19) #myhl(other)[Israel] then sent messengers to #myhl(men)[Sihon] king of the #myhl(other)[Amorites], king of #myhl(places)[Heshbon], and #myhl(other)[Israel] said to him, ‘Please let us pass through your land to our country,’ 
#versenum(20) but #myhl(men)[Sihon] did not #underline[trust] #myhl(other)[Israel] to pass through his territory, so #myhl(men)[Sihon] gathered all his people together and encamped at #myhl(places)[Jahaz] and fought with #myhl(other)[Israel]. 
#versenum(21) And the #myhl(divine)[#smallcaps[Lord], the God of Israel], gave #myhl(men)[Sihon] and all his people into the hand of #myhl(other)[Israel], and they defeated them. So #myhl(other)[Israel] took possession of all the land of the #myhl(other)[Amorites], who inhabited that country. 
...
#versenum(23) So then the #myhl(divine)[#smallcaps[Lord], the God of Israel], dispossessed the #myhl(other)[Amorites] from before his people #myhl(other)[Israel]; and are you to take possession of them? 
...
#versenum(25) Now are you any better than #myhl(men)[Balak] the son of #myhl(men)[Zippor], king of #myhl(places)[Moab]? Did he ever contend against #myhl(other)[Israel], or did he ever go to war with them? 
#versenum(26) While #myhl(other)[Israel] lived in #myhl(places)[Heshbon] and its villages, and in #myhl(places)[Aroer] and its villages, and in all the cities that are on the banks of the #myhl(places)[Arnon], #myhl(numbers)[300] years, why did you not deliver them within that time? 
...
#versenum(40) that the daughters of #myhl(other)[Israel] went year by year to #underline[lament] the daughter of #myhl(men)[Jephthah] the #myhl(other)[Gileadite] #myhl(numbers)[four] days in the year.
...
#versenum(7) #myhl(men)[Jephthah] judged #myhl(other)[Israel] #myhl(numbers)[six] years. Then #myhl(men)[Jephthah] the #myhl(other)[Gileadite] died and was buried in his city in #myhl(places)[Gilead].#footnote[Judges 12:7 Septuagint; Hebrew #emph[in the cities of Gilead]]
...
#versenum(8) After him #myhl(men)[Ibzan] of #myhl(places)[Bethlehem] judged #myhl(other)[Israel]. 
#versenum(9) He had #myhl(numbers)[thirty] sons, and #myhl(numbers)[thirty] daughters he gave in marriage outside his clan, and #myhl(numbers)[thirty] daughters he brought in from outside for his sons. And he judged #myhl(other)[Israel] #myhl(numbers)[seven] years. 
#versenum(10) Then #myhl(men)[Ibzan] died and was buried at #myhl(places)[Bethlehem].


  
#versenum(11) After him #myhl(men)[Elon] the #myhl(other)[Zebulunite] judged #myhl(other)[Israel], and he judged #myhl(other)[Israel] #myhl(numbers)[ten] years. 
...
#versenum(13) After him #myhl(men)[Abdon] the son of #myhl(men)[Hillel] the #myhl(other)[Pirathonite] judged #myhl(other)[Israel]. 
#versenum(14) He had #myhl(numbers)[forty] sons and #myhl(numbers)[thirty] #underline[grandsons], who rode on #myhl(numbers)[seventy] donkeys, and he judged #myhl(other)[Israel] #myhl(numbers)[eight] years. 
...
#versenum(5) for behold, you shall conceive and bear a son. No razor shall come upon his head, for the child shall be a #myhl(other)[Nazirite] to #myhl(divine)[God] from the womb, and he shall begin to save #myhl(other)[Israel] from the hand of the #myhl(other)[Philistines].” 
...
#versenum(4) His father and mother did not know that it was from the #myhl(divine)[#smallcaps[Lord]], for he was seeking an #underline[opportunity] against the #myhl(other)[Philistines]. At that time the #myhl(other)[Philistines] ruled over #myhl(other)[Israel].
...
#versenum(20) And he judged #myhl(other)[Israel] in the days of the #myhl(other)[Philistines] #myhl(numbers)[twenty] years.
...
#versenum(31) Then his brothers and all his family came down and took him and brought him up and buried him between #myhl(places)[Zorah] and #myhl(places)[Eshtaol] in the tomb of #myhl(men)[Manoah] his father. He had judged #myhl(other)[Israel] #myhl(numbers)[twenty] years.
...
#versenum(1) In those days there was no king in #myhl(places)[Israel]. And in those days the tribe of the people of #myhl(other)[Dan] was seeking for itself an inheritance to dwell in, for until then no inheritance among the tribes of #myhl(other)[Israel] had fallen to them. 
...
#versenum(29) And they named the city #myhl(other)[Dan], after the name of #myhl(other)[Dan] their ancestor, who was born to #myhl(other)[Israel]; but the name of the city was #myhl(places)[Laish] at the first. 
...
#versenum(2) And the chiefs of all the people, of all the tribes of #myhl(other)[Israel], presented themselves in the assembly of the people of #myhl(divine)[God], #myhl(numbers)[400,000] men on foot that drew the sword. 
...
#versenum(6) So I took hold of my concubine and cut her in pieces and sent her throughout all the country of the inheritance of #myhl(other)[Israel], for they have committed #underline[abomination] and outrage in #myhl(places)[Israel]. 
...
#versenum(10) and we will take #myhl(numbers)[ten] men of a #myhl(numbers)[hundred] throughout all the tribes of #myhl(other)[Israel], and a #myhl(numbers)[hundred] of a #myhl(numbers)[thousand], and a #myhl(numbers)[thousand of ten thousand], to bring provisions for the people, that when they come they may repay #myhl(places)[Gibeah] of #myhl(men)[Benjamin] for all the outrage that they have committed in #myhl(places)[Israel].” 
#versenum(11) So all the #myhl(people-groups)[men of Israel] gathered against the city, #underline[united] as one man.


  
#versenum(12) And the tribes of #myhl(other)[Israel] sent men through all the tribe of #myhl(men)[Benjamin], saying, “What evil is this that has taken place among you? 
#versenum(13) Now therefore give up the men, the worthless fellows in #myhl(places)[Gibeah], that we may put them to death and #underline[purge] evil from #myhl(other)[Israel].” But the #myhl(other)[Benjaminites] would not listen to the voice of their brothers, the #myhl(people-groups)[people of Israel]. 
...
#versenum(29) So #myhl(other)[Israel] set men in ambush around #myhl(places)[Gibeah]. 
...
#versenum(34) And there came against #myhl(places)[Gibeah] #myhl(numbers)[10,000] chosen men out of all #myhl(other)[Israel], and the battle was hard, but the #myhl(other)[Benjaminites] did not know that disaster was close upon them. 
#versenum(35) And the #myhl(divine)[#smallcaps[Lord]] defeated #myhl(men)[Benjamin] before #myhl(other)[Israel], and the #myhl(people-groups)[people of Israel] destroyed #underline[#myhl(numbers)[25,100]] men of #myhl(men)[Benjamin] that day. All these were men who drew the sword. 
...
#versenum(5) And the #myhl(people-groups)[people of Israel] said, “Which of all the tribes of #myhl(other)[Israel] did not come up in the assembly to the #myhl(divine)[#smallcaps[Lord]]?” For they had taken a great oath concerning him who did not come up to the #myhl(divine)[#smallcaps[Lord]] to #myhl(places)[Mizpah], saying, “He shall surely be put to death.” 
#versenum(6) And the #myhl(people-groups)[people of Israel] had compassion for #myhl(men)[Benjamin] their brother and said, “One tribe is cut off from #myhl(other)[Israel] this day. 
...
#versenum(8) And they said, “What one is there of the tribes of #myhl(other)[Israel] that did not come up to the #myhl(divine)[#smallcaps[Lord]] to #myhl(places)[Mizpah]?” And behold, no one had come to the camp from #myhl(places)[Jabesh-gilead], to the assembly. 
...
#versenum(15) And the people had compassion on #myhl(men)[Benjamin] because the #myhl(divine)[#smallcaps[Lord]] had made a breach in the tribes of #myhl(other)[Israel].
...
#versenum(17) And they said, “There must be an inheritance for the #underline[survivors] of #myhl(men)[Benjamin], that a tribe not be #underline[blotted] out from #myhl(other)[Israel]. 
